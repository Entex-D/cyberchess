...
if($hod=='7' || $hod=='17') { $slovo='дельфина'; }
if($hod=='8' || $hod=='18') { $slovo='легенды'; }
if($hod=='9' || $hod=='19') { $slovo='ёжика'; }
...
if($b11==1 && $dobro!='Da') {  $hod_attack=$q1; $position=$position+1; //echo "Допустимый ход $slovo: ($newX, $newY)&nbsp;";   echo "Ход с $index на $hod_attack<br />";
 include('attack.php'); 
} else $b11=0;
