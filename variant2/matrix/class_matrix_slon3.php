...
if($sh[$hod_one]=='8' | $sh[$hod_one]=='18')  { if($sh[$hod_two]=='40') { $bb='1'; }}

if($sh[$hod_one]=='4' | $sh[$hod_one]=='14')  { $bbb='1'; }

if($bb=='1' || $bbb=='1')  {

if($sh[$hod_one]=='4' | $sh[$hod_one]=='14') { $t='Слон'; } else if($sh[$hod_one]=='8' | $sh[$hod_one]=='18') { $t='Легенда'; }
