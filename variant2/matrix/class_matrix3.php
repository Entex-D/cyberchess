...
if($prov!='1' & $prov!='-1' & $prov!='24' & $prov!='-24') { echo '<br>Дельфин бьёт по другому = ['.$prov.']'; $hod_one='1000'; $hod_two='1000'; }

                                                  } else if($sh[$hod_two]=='40' || $sh[$hod_two]=='81' || $sh[$hod_two]=='82' || $sh[$hod_two]=='83') {

if($prov!='2' & $prov!='-2' & $prov!='3' & $prov!='-3' &
 $prov!='50' & $prov!='-50' & $prov!='46' & $prov!='-46' &
$prov!='75' & $prov!='-75' & $prov!='69' & $prov!='-69' &
$prov!='48' & $prov!='-48' & $prov!='72' & $prov!='-72') { echo '<br>Дельфин ходит по другому = ['.$prov.']'; $hod_one='1000'; $hod_two='1000'; }
...
$prov!='47' & $prov!='-47' & $prov!='26' & $prov!='-26') { echo '<br>Легенда бьёт по другому = ['.$prov.']'; $hod_one='1000'; $hod_two='1000'; }
...
$prov!='207' & $prov!='225' & $prov!='-207' & $prov!='-225' & 
$prov!='230' & $prov!='250' & $prov!='-230' & $prov!='-250' &
 $prov!='253' & $prov!='300' & $prov!='-258' & $prov!='-300') { echo '<br>Легенда ходит по другому = ['.$prov.']'; $hod_one='1000'; $hod_two='1000'; }
...
if($prov!='1' & $prov!='-1' & $prov!='24' & $prov!='-24' &
 $prov!='23' & $prov!='-23' & $prov!='25' & $prov!='-25') { echo '<br>Ёжик бьёт по другому = ['.$prov.']'; $hod_one='1000'; $hod_two='1000'; }

                                                  } else if($sh[$hod_two]=='40' || $sh[$hod_two]=='81' || $sh[$hod_two]=='82' || $sh[$hod_two]=='83') {

if($prov!='2' & $prov!='-2' & $prov!='49' & $prov!='-49' &
 $prov!='48' & $prov!='-48' & $prov!='47' & $prov!='-47' &
$prov!='26' & $prov!='-26' & $prov!='22' & $prov!='-22') { echo '<br>Ёжик ходит по другому = ['.$prov.']'; $hod_one='1000'; $hod_two='1000'; }
