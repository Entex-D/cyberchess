...
if($index_to) {  $hod_one=$index; $hod_two=$index_to; }
  ...
  if($index_to) {  $hod_one=$index; $hod_two=$index_to; }
    ...
    if($sh[$index+2]>10 && $sh[$index+2]<20) { $index_to=$index+2; echo 'Выбрана цель для атаки черной легенды: '.$index_to.'<br>'; }
    if($sh[$index-48]>10 && $sh[$index-48]<20) { $index_to=$index-48; echo 'Выбрана цель для атаки черной легенды: '.$index_to.'<br>'; }
    if($sh[$index+48]>10 && $sh[$index+48]<20) { $index_to=$index+48; echo 'Выбрана цель для атаки черной легенды: '.$index_to.'<br>'; }
    if($sh[$index-2]>10 && $sh[$index-2]<20) { $index_to=$index-2; echo 'Выбрана цель для атаки черной легенды: '.$index_to.'<br>'; }
    if($sh[$index+22]>10 && $sh[$index+22]<20) { $index_to=$index+22; echo 'Выбрана цель для атаки черной легенды: '.$index_to.'<br>'; }
    if($sh[$index+26]>10 && $sh[$index+26]<20) { $index_to=$index+26; echo 'Выбрана цель для атаки черной легенды: '.$index_to.'<br>'; }
    if($sh[$index-22]>10 && $sh[$index-22]<20) { $index_to=$index-22; echo 'Выбрана цель для атаки черной легенды: '.$index_to.'<br>'; }
    if($sh[$index-26]>10 && $sh[$index-26]<20) { $index_to=$index-26; echo 'Выбрана цель для атаки черной легенды: '.$index_to.'<br>'; }
    if($sh[$index+47]>10 && $sh[$index+47]<20) { $index_to=$index+47; echo 'Выбрана цель для атаки черной легенды: '.$index_to.'<br>'; }
    if($sh[$index+49]>10 && $sh[$index+49]<20) { $index_to=$index+49; echo 'Выбрана цель для атаки черной легенды: '.$index_to.'<br>'; }
    if($sh[$index-47]>10 && $sh[$index-47]<20) { $index_to=$index-47; echo 'Выбрана цель для атаки черной легенды: '.$index_to.'<br>'; }
    if($sh[$index-49]>10 && $sh[$index-49]<20) { $index_to=$index-49; echo 'Выбрана цель для атаки черной легенды: '.$index_to.'<br>'; }
...
if($index_to) {  $hod_one=$index; $hod_two=$index_to; }
    ...
    if($sh[$index+2]>0 && $sh[$index+2]<10) { $index_to=$index+2; echo 'Выбрана цель для атаки белой легенды: '.$index_to.'<br>'; }
    if($sh[$index-48]>0 && $sh[$index-48]<10) { $index_to=$index-48; echo 'Выбрана цель для атаки белой легенды: '.$index_to.'<br>'; }
    if($sh[$index+48]>0 && $sh[$index+48]<10) { $index_to=$index+48; echo 'Выбрана цель для атаки белой легенды: '.$index_to.'<br>'; }
    if($sh[$index-2]>0 && $sh[$index-2]<10) { $index_to=$index-2; echo 'Выбрана цель для атаки белой легенды: '.$index_to.'<br>'; }
    if($sh[$index+22]>0 && $sh[$index+22]<10) { $index_to=$index+22; echo 'Выбрана цель для атаки белой легенды: '.$index_to.'<br>'; }
    if($sh[$index+26]>0 && $sh[$index+26]<10) { $index_to=$index+26; echo 'Выбрана цель для атаки белой легенды: '.$index_to.'<br>'; }
    if($sh[$index-22]>0 && $sh[$index-22]<10) { $index_to=$index-22; echo 'Выбрана цель для атаки белой легенды: '.$index_to.'<br>'; }
    if($sh[$index-26]>0 && $sh[$index-26]<10) { $index_to=$index-26; echo 'Выбрана цель для атаки белой легенды: '.$index_to.'<br>'; }
    if($sh[$index+47]>0 && $sh[$index+47]<10) { $index_to=$index+47; echo 'Выбрана цель для атаки белой легенды: '.$index_to.'<br>'; }
    if($sh[$index+49]>0 && $sh[$index+49]<10) { $index_to=$index+49; echo 'Выбрана цель для атаки белой легенды: '.$index_to.'<br>'; }
    if($sh[$index-47]>0 && $sh[$index-47]<10) { $index_to=$index-47; echo 'Выбрана цель для атаки белой легенды: '.$index_to.'<br>'; }
    if($sh[$index-49]>0 && $sh[$index-49]<10) { $index_to=$index-49; echo 'Выбрана цель для атаки белой легенды: '.$index_to.'<br>'; }
  ...
  if($index_to) {  $hod_one=$index; $hod_two=$index_to; }
    ...
    if($sh[$index+1]>10 && $sh[$index+1]<20) { $index_to=$index+1; echo 'Выбрана цель для атаки черного дельфина: '.$index_to.'<br>'; }
    if($sh[$index-24]>10 && $sh[$index-24]<20) { $index_to=$index-24; echo 'Выбрана цель для атаки черного дельфина: '.$index_to.'<br>'; }
    if($sh[$index+24]>10 && $sh[$index+24]<20) { $index_to=$index+24; echo 'Выбрана цель для атаки черного дельфина: '.$index_to.'<br>'; }
    if($sh[$index-1]>10 && $sh[$index-1]<20) { $index_to=$index-1; echo 'Выбрана цель для атаки черного дельфина: '.$index_to.'<br>'; }
...
if($index_to) {  $hod_one=$index; $hod_two=$index_to; }
    ...
    if($sh[$index+1]>0 && $sh[$index+1]<10) { $index_to=$index+1; echo 'Выбрана цель для атаки белого дельфина: '.$index_to.'<br>'; }
    if($sh[$index-24]>0 && $sh[$index-24]<10) { $index_to=$index-24; echo 'Выбрана цель для атаки белого дельфина: '.$index_to.'<br>'; }
    if($sh[$index+24]>0 && $sh[$index+24]<10) { $index_to=$index+24; echo 'Выбрана цель для атаки белого дельфина: '.$index_to.'<br>'; }
    if($sh[$index-1]>0 && $sh[$index-1]<10) { $index_to=$index-1; echo 'Выбрана цель для атаки белого дельфина: '.$index_to.'<br>'; }
  ...
  if($index_to) {  $hod_one=$index; $hod_two=$index_to; }
    ...
    if($sh[$index+1]>10 && $sh[$index+1]<20) { $index_to=$index+1; echo 'Выбрана цель для атаки черного ёжика: '.$index_to.'<br>'; }
    if($sh[$index-1]>10 && $sh[$index-1]<20) { $index_to=$index-1; echo 'Выбрана цель для атаки черного ёжика: '.$index_to.'<br>'; }
    if($sh[$index+24]>10 && $sh[$index+24]<20) { $index_to=$index+24; echo 'Выбрана цель для атаки черного ёжика: '.$index_to.'<br>'; }
    if($sh[$index-24]>10 && $sh[$index-24]<20) { $index_to=$index-24; echo 'Выбрана цель для атаки черного ёжика: '.$index_to.'<br>'; }
    if($sh[$index+23]>10 && $sh[$index+23]<20) { $index_to=$index+23; echo 'Выбрана цель для атаки черного ёжика: '.$index_to.'<br>'; }
    if($sh[$index+25]>10 && $sh[$index+25]<20) { $index_to=$index+25; echo 'Выбрана цель для атаки черного ёжика: '.$index_to.'<br>'; }
    if($sh[$index-23]>10 && $sh[$index-23]<20) { $index_to=$index-23; echo 'Выбрана цель для атаки черного ёжика: '.$index_to.'<br>'; }
    if($sh[$index-25]>10 && $sh[$index-25]<20) { $index_to=$index-25; echo 'Выбрана цель для атаки черного ёжика: '.$index_to.'<br>'; }
...
if($index_to) {  $hod_one=$index; $hod_two=$index_to; }
   ...
   if($sh[$index+1]>0 && $sh[$index+1]<10) { $index_to=$index+1; echo 'Выбрана цель для атаки белого ёжика: '.$index_to.'<br>'; }
    if($sh[$index-1]>0 && $sh[$index-1]<10) { $index_to=$index-1; echo 'Выбрана цель для атаки белого ёжика: '.$index_to.'<br>'; }
    if($sh[$index+24]>0 && $sh[$index+24]<10) { $index_to=$index+24; echo 'Выбрана цель для атаки белого ёжика: '.$index_to.'<br>'; }
    if($sh[$index-24]>0 && $sh[$index-24]<10) { $index_to=$index-24; echo 'Выбрана цель для атаки белого ёжика: '.$index_to.'<br>'; }
    if($sh[$index+23]>0 && $sh[$index+23]<10) { $index_to=$index+23; echo 'Выбрана цель для атаки белого ёжика: '.$index_to.'<br>'; }
    if($sh[$index+25]>0 && $sh[$index+25]<10) { $index_to=$index+25; echo 'Выбрана цель для атаки белого ёжика: '.$index_to.'<br>'; }
    if($sh[$index-23]>0 && $sh[$index-23]<10) { $index_to=$index-23; echo 'Выбрана цель для атаки белого ёжика: '.$index_to.'<br>'; }
    if($sh[$index-25]>0 && $sh[$index-25]<10) { $index_to=$index-25; echo 'Выбрана цель для атаки белого ёжика: '.$index_to.'<br>'; }
