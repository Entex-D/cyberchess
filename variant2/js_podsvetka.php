          ...
          if(x1Cell !== null) {   x1Cell.classList.toggle('highlighted2');   }
            ...
            if(x15Cell !== null) {   x15Cell.classList.toggle('highlighted2');   }
             ...
             if(x18Cell !== null) {   x18Cell.classList.toggle('highlighted2');   }
                   ...
                   const x190Cell = document.getElementById(di[f+25]);
            const x290Cell = document.getElementById(di[f-25]);
            const x390Cell = document.getElementById(di[f+23]);
            const x490Cell = document.getElementById(di[f-23]);
           
            const x590Cell = document.getElementById(di[f+50]);
            const x690Cell = document.getElementById(di[f-50]);
            const x790Cell = document.getElementById(di[f+46]);
            const x890Cell = document.getElementById(di[f-46]);
          
            const x990Cell = document.getElementById(di[f+75]);
            const x1090Cell = document.getElementById(di[f-75]);
            const x1190Cell = document.getElementById(di[f+69]);
            const x1290Cell = document.getElementById(di[f-69]);
          
            const x1390Cell = document.getElementById(di[f+100]);
            const x1490Cell = document.getElementById(di[f-100]);
            const x1590Cell = document.getElementById(di[f+92]);
            const x1690Cell = document.getElementById(di[f-92]);
                      
            const x1790Cell = document.getElementById(di[f+125]);
            const x1890Cell = document.getElementById(di[f-125]);
            const x1990Cell = document.getElementById(di[f+115]);
            const x2090Cell = document.getElementById(di[f-115]);
                      
            const x2190Cell = document.getElementById(di[f+150]);
            const x2290Cell = document.getElementById(di[f-150]);
            const x2390Cell = document.getElementById(di[f+138]);
            const x2490Cell = document.getElementById(di[f-138]);
                      
            const x2590Cell = document.getElementById(di[f+175]);
            const x2690Cell = document.getElementById(di[f-175]);
            const x2790Cell = document.getElementById(di[f+161]);
            const x2890Cell = document.getElementById(di[f-161]);
            

      if(x190Cell !== null) {     if(sh_d[f+25]<'40')   {       x190Cell.classList.toggle('highlighted2'); } else x190Cell.classList.toggle('highlighted'); }
     if(x290Cell !== null) {     if(sh_d[f-25]<'40')   {       x290Cell.classList.toggle('highlighted2'); } else x290Cell.classList.toggle('highlighted'); }
     if(x390Cell !== null) {     if(sh_d[f+23]<'40')   {       x390Cell.classList.toggle('highlighted2'); } else x390Cell.classList.toggle('highlighted'); }
     if(x490Cell !== null) {     if(sh_d[f-23]<'40')   {       x490Cell.classList.toggle('highlighted2'); } else x490Cell.classList.toggle('highlighted'); }
     
     if(x590Cell !== null) {      if(sh_d[f+25]>'30')   { if(sh_d[f+50]<'40')   {       x590Cell.classList.toggle('highlighted2'); } else x590Cell.classList.toggle('highlighted'); } }
     if(x690Cell !== null) {      if(sh_d[f-25]>'30')   { if(sh_d[f-50]<'40')   {       x690Cell.classList.toggle('highlighted2'); } else x690Cell.classList.toggle('highlighted'); } } 
     if(x790Cell !== null) {      if(sh_d[f+23]>'30')   { if(sh_d[f+46]<'40')   {       x790Cell.classList.toggle('highlighted2'); } else x790Cell.classList.toggle('highlighted'); } }       
     if(x890Cell !== null) {      if(sh_d[f-23]>'30')   { if(sh_d[f-46]<'40')   {       x890Cell.classList.toggle('highlighted2'); } else x890Cell.classList.toggle('highlighted'); } }
     
     if(x990Cell !== null) {      if(sh_d[f+25]>'30' && sh_d[f+50]>'30')   { if(sh_d[f+75]<'40')   {       x990Cell.classList.toggle('highlighted2'); } else x990Cell.classList.toggle('highlighted'); } }
     if(x1090Cell !== null) {     if(sh_d[f-25]>'30' && sh_d[f-50]>'30')   {  if(sh_d[f-75]<'40')   {       x1090Cell.classList.toggle('highlighted2'); } else x1090Cell.classList.toggle('highlighted'); } }
     if(x1190Cell !== null) {     if(sh_d[f+23]>'30' && sh_d[f+46]>'30')   {  if(sh_d[f+69]<'40')   {       x1190Cell.classList.toggle('highlighted2'); } else x1190Cell.classList.toggle('highlighted'); } }
     if(x1290Cell !== null) {     if(sh_d[f-23]>'30' && sh_d[f-46]>'30')   {  if(sh_d[f-69]<'40')   {       x1290Cell.classList.toggle('highlighted2'); } else x1290Cell.classList.toggle('highlighted'); } }
     
     if(x1390Cell !== null) {     if(sh_d[f+25]>'30' && sh_d[f+50]>'30' && sh_d[f+75]>'30')   {  if(sh_d[f+100]<'40')   {       x1390Cell.classList.toggle('highlighted2'); } else x1390Cell.classList.toggle('highlighted'); } }
     if(x1490Cell !== null) {     if(sh_d[f-25]>'30' && sh_d[f-50]>'30' && sh_d[f-75]>'30')   {   if(sh_d[f-100]<'40')   {       x1490Cell.classList.toggle('highlighted2'); } else x1490Cell.classList.toggle('highlighted'); } }
     if(x1590Cell !== null) {     if(sh_d[f+23]>'30' && sh_d[f+46]>'30' && sh_d[f+69]>'30')   {   if(sh_d[f+92]<'40')   {       x1590Cell.classList.toggle('highlighted2'); } else x1590Cell.classList.toggle('highlighted'); } }
     if(x1690Cell !== null) {     if(sh_d[f-23]>'30' && sh_d[f-46]>'30' && sh_d[f-69]>'30')   {   if(sh_d[f-92]<'40')   {       x1690Cell.classList.toggle('highlighted2'); } else x1690Cell.classList.toggle('highlighted'); } }
     
     if(x1790Cell !== null) {     if(sh_d[f+25]>'30' && sh_d[f+50]>'30' && sh_d[f+75]>'30' && sh_d[f+100]>'30')   {  if(sh_d[f+125]<'40')   {       x1790Cell.classList.toggle('highlighted2'); } else x1790Cell.classList.toggle('highlighted'); } }
     if(x1890Cell !== null) {     if(sh_d[f-25]>'30' && sh_d[f-50]>'30' && sh_d[f-75]>'30' && sh_d[f-100]>'30')   {  if(sh_d[f-125]<'40')   {       x1890Cell.classList.toggle('highlighted2'); } else x1890Cell.classList.toggle('highlighted'); } }
     if(x1990Cell !== null) {     if(sh_d[f+23]>'30' && sh_d[f+46]>'30' && sh_d[f+69]>'30' && sh_d[f+92]>'30')   {  if(sh_d[f+115]<'40')   {       x1990Cell.classList.toggle('highlighted2'); } else x1990Cell.classList.toggle('highlighted'); } }
     if(x2090Cell !== null) {     if(sh_d[f-23]>'30' && sh_d[f-46]>'30' && sh_d[f-69]>'30' && sh_d[f-92]>'30')   {  if(sh_d[f-115]<'40')   {       x2090Cell.classList.toggle('highlighted2'); } else x2090Cell.classList.toggle('highlighted'); } }
     
     if(x2190Cell !== null) {     if(sh_d[f+25]>'30' && sh_d[f+50]>'30' && sh_d[f+75]>'30' && sh_d[f+100]>'30' && sh_d[f+125]>'30')   {  if(sh_d[f+150]<'40')   {       x2190Cell.classList.toggle('highlighted2'); } else x2190Cell.classList.toggle('highlighted'); } }
     if(x2290Cell !== null) {     if(sh_d[f-25]>'30' && sh_d[f-50]>'30' && sh_d[f-75]>'30' && sh_d[f-100]>'30' && sh_d[f-125]>'30')   {  if(sh_d[f-150]<'40')   {       x2290Cell.classList.toggle('highlighted2'); } else x2290Cell.classList.toggle('highlighted'); } }
     if(x2390Cell !== null) {     if(sh_d[f+23]>'30' && sh_d[f+6]>'30' && sh_d[f+69]>'30' && sh_d[f+92]>'30' && sh_d[f+115]>'30')   {  if(sh_d[f+138]<'40')   {       x2390Cell.classList.toggle('highlighted2'); } else x2390Cell.classList.toggle('highlighted'); } }
     if(x2490Cell !== null) {     if(sh_d[f-23]>'30' && sh_d[f-46]>'30' && sh_d[f-69]>'30' && sh_d[f-92]>'30' && sh_d[f-115]>'30')   {  if(sh_d[f-138]<'40')   {       x2490Cell.classList.toggle('highlighted2'); } else x2490Cell.classList.toggle('highlighted'); } }
     
     if(x2590Cell !== null) {     if(sh_d[f+25]>'30' && sh_d[f+50]>'30' && sh_d[f+75]>'30' && sh_d[f+100]>'30' && sh_d[f+125]>'30' && sh_d[f+150]>'30')   {  if(sh_d[f+175]<'40')   {       x2590Cell.classList.toggle('highlighted2'); } else x2590Cell.classList.toggle('highlighted'); } }
     if(x2690Cell !== null) {     if(sh_d[f-25]>'30' && sh_d[f-50]>'30' && sh_d[f-75]>'30' && sh_d[f-100]>'30' && sh_d[f-125]>'30' && sh_d[f-150]>'30')   {  if(sh_d[f-175]<'40')   {       x2690Cell.classList.toggle('highlighted2'); } else x2690Cell.classList.toggle('highlighted'); } }
     if(x2790Cell !== null) {     if(sh_d[f+23]>'30' && sh_d[f+46]>'30' && sh_d[f+69]>'30' && sh_d[f+92]>'30' && sh_d[f+115]>'30' && sh_d[f+138]>'30')   {  if(sh_d[f+161]<'40')   {       x2790Cell.classList.toggle('highlighted2'); } else x2790Cell.classList.toggle('highlighted'); } }
     if(x2890Cell !== null) {     if(sh_d[f-23]>'30' && sh_d[f-46]>'30' && sh_d[f-69]>'30' && sh_d[f-92]>'30' && sh_d[f-115]>'30' && sh_d[f-138]>'30')   {  if(sh_d[f-161]<'40')   {       x2890Cell.classList.toggle('highlighted2'); } else x2890Cell.classList.toggle('highlighted'); } }
...
if (sh_d[f]=='17' | sh_d[f]=='7') {
    ...
    const x1Cell = document.getElementById(di[f+2]);
            ...
            const x19Cell = document.getElementById(di[f+1]);
            const x20Cell = document.getElementById(di[f-1]);
            const x21Cell = document.getElementById(di[f+24]);
            const x22Cell = document.getElementById(di[f-24]);
...
if (sh_d[f]=='19' | sh_d[f]=='9') {
            ...
            const x9Cell = document.getElementById(di[f+2]);
            const x10Cell = document.getElementById(di[f-2]);
            const x11Cell = document.getElementById(di[f+48]);
            const x12Cell = document.getElementById(di[f-48]);
            const x13Cell = document.getElementById(di[f+49]);
            const x14Cell = document.getElementById(di[f-49]);
            const x15Cell = document.getElementById(di[f+47]);
            const x16Cell = document.getElementById(di[f-47]);
            
            const x17Cell = document.getElementById(di[f+26]);
            const x18Cell = document.getElementById(di[f-26]);
            const x19Cell = document.getElementById(di[f+22]);
            const x20Cell = document.getElementById(di[f-22]);
