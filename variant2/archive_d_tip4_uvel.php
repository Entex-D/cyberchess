...
<table width=90%><tr>
<td class=td_center><center><font size=4><br><strong><a href=#>[[</a> Просмотр доски <? echo $nomer2; ?> игрока <? echo $namer; ?> <a href=#>]]</a></strong><br></font></center></td></tr></table>
...
$ndoski='../archive_doski/'.$namer.'/tip2/'.$nomer2.'/'.$nomer2.'_hody.txt';
 $b4='0';
...
$fdoski='../archive_doski/'.$namer.'/tip2/'.$nomer2.'/'.$nomer2.'.txt';
 $b5='0';
...
$fstatix='../archive_doski/'.$namer.'/tip2/'.$nomer2.'/'.$nomer2.'_statix.txt';
 $b6='0';
...
<? include('../variant2/shah.php'); ?>
<? if($zvuki_hody=='11') { include('../variant2/zvuk_uvel.php'); } ?>
...
if($figury[$sx]=='7') { $sh[$sx]='../picture/new_figure/black_delf.png'; }
if($figury[$sx]=='9') { $sh[$sx]='../picture/new_figure/egik_black.jpg'; }
...
if($figury[$sx]=='17') { $sh[$sx]='../picture/'.$figure_x.'white_delf.png'; }
if($figury[$sx]=='18') { $sh[$sx]='../picture/'.$figure_x.'legenda_white.png'; }
if($figury[$sx]=='8') { $sh[$sx]='../picture/new_figure/legenda_black.png'; }
if($figury[$sx]=='19') { $sh[$sx]='../picture/'.$figure_x.'egik_white.png'; }
...
<? echo '&nbsp;&nbsp;&nbsp;&nbsp;Правила на доске '.$nomer2.', игрока '.$namer.':'; ?>
</strong><br><br></font>

<? $fixxa='figure_style'.$style_run.'/'; ?>

<font size=2><strong><em>
&nbsp;&nbsp;&nbsp;&nbsp;<a target=_blank href=../model_game/<? echo $fixxa; ?>pravila_legenda.jpg>Правила ходов у Легенды</a><br>
&nbsp;&nbsp;&nbsp;&nbsp;<a target=_blank href=../model_game/<? echo $fixxa; ?>pravila_delfin_tip8.jpg>Правила ходов у Дельфина</a><br>
&nbsp;&nbsp;&nbsp;&nbsp;<a target=_blank href=../model_game/<? echo $fixxa; ?>pravila_egik.jpg>Правила ходов у Ёжика</a><br>

<br>

Конь,Ладья,Слон,Ферзь,Легенда и Дельфин могут меняться местами<br>
Каждые <? echo $transform_index; ?> ходов 6 фигур рандомно превращаются ( Конь, Слон, Ферзь, Ладья, Легенда и Дельфин )<br>
За убитые фигуры зачисляются баллы<br>
За 20 баллов случайная пешка превращается в Легенду,Дельфина или в Ёжика<br>
...
<meta http-equiv='refresh' content='40;url=archive_d_tip4_uvel.php?namer=<? echo $namer; ?>&tip=2&nomer2=<? echo $nomer2; ?>'>
