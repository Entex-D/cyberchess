...
<br><div class="cell2" id="">7</div>
 ...
 <? $x=$x+'17'; ?> <div class="cell dark" id="A7"><img src="<?echo $sh[$x]?>" <? echo 'width='.$width; echo 'height='.$height; ?>></div>
...
<div class="cell2" id="">6</div>
 ...
 <? $x=$x+'17'; ?> <div class="cell" id="A6"><img src="<?echo $sh[$x]?>" <? echo 'width='.$width; echo 'height='.$height; ?>></div>
...
<div class="cell2" id="">5</div>
 ...
 <? $x=$x+'17'; ?> <div class="cell dark" id="A5"><img src="<?echo $sh[$x]?>" <? echo 'width='.$width; echo 'height='.$height; ?>></div>
...
<div class="cell2" id="">4</div>
 ...
 <? $x=$x+'17'; ?> <div class="cell" id="A4"><img src="<?echo $sh[$x]?>" <? echo 'width='.$width; echo 'height='.$height; ?>></div>
...
<div class="cell2" id="">3</div>
 ...
 <? $x=$x+'17'; ?> <div class="cell dark" id="A3"><img src="<?echo $sh[$x]?>" <? echo 'width='.$width; echo 'height='.$height; ?>></div>
...
<div class="cell2" id="">2</div>
 ...
 <? $x=$x+'17'; ?> <div class="cell" id="A2"><img src="<?echo $sh[$x]?>" <? echo 'width='.$width; echo 'height='.$height; ?>></div>
...
<div class="cell2" id="">1</div>
 ...
 <? $x=$x+'17'; ?> <div class="cell dark" id="A1"><img src="<?echo $sh[$x]?>" <? echo 'width='.$width; echo 'height='.$height; ?>></div>
