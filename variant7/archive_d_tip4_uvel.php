...
<table width=90%><tr>
<td class=td_center><center><font size=4><br><strong><a href=#>[[</a> Просмотр доски <? echo $nomer7; ?> игрока <? echo $namer; ?> <a href=#>]]</a></strong><br></font></center></td></tr></table>
...
$ndoski='../archive_doski/'.$namer.'/tip7/'.$nomer7.'/'.$nomer7.'_hody.txt';
 $b4='0';
...
$fdoski='../archive_doski/'.$namer.'/tip7/'.$nomer7.'/'.$nomer7.'.txt';
 $b5='0';
...
$fstatix='../archive_doski/'.$namer.'/tip7/'.$nomer7.'/'.$nomer7.'_statix.txt';
 $b6='0';
...
<? if($zvuki_hody=='11') { include('../variant7/zvuk_uvel.php'); } ?>
...
<? echo '&nbsp;&nbsp;&nbsp;&nbsp;Правила на доске '.$nomer7.', игрока '.$namer.':'; ?>
</strong><br><br></font>
...
<meta http-equiv='refresh' content='40;url=archive_d_tip4_uvel.php?namer=<? echo $namer; ?>&tip=7&nomer7=<? echo $nomer7; ?>'>
