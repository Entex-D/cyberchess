...
if(!$shah && !$ugroza) { $yes='da'; }
$qq=rand(0,1);

if($qq==0 && $yes!='da') { $ok='da'; } else if($yes=='da') { $ok='da'; }
...
if($index_to) {  $hod_one=$index; $hod_two=$index_to; }
  ...
  if($index_to) {  $hod_one=$index; $hod_two=$index_to; }
    ...
    if($sh[$index+2]>10 && $sh[$index+2]<20) { $index_to=$index+2; echo 'Выбрана цель для атаки черной стрелы: '.$index_to.'<br>'; }
    if($sh[$index-48]>10 && $sh[$index-48]<20) { $index_to=$index-48; echo 'Выбрана цель для атаки черной стрелы: '.$index_to.'<br>'; }
    if($sh[$index+48]>10 && $sh[$index+48]<20) { $index_to=$index+48; echo 'Выбрана цель для атаки черной стрелы: '.$index_to.'<br>'; }
    if($sh[$index-2]>10 && $sh[$index-2]<20) { $index_to=$index-2; echo 'Выбрана цель для атаки черной стрелы: '.$index_to.'<br>'; }
...
if($index_to) {  $hod_one=$index; $hod_two=$index_to; }
    ...
    if($sh[$index+2]>0 && $sh[$index+2]<10) { $index_to=$index+2; echo 'Выбрана цель для атаки белой стрелы: '.$index_to.'<br>'; }
    if($sh[$index-48]>0 && $sh[$index-48]<10) { $index_to=$index-48; echo 'Выбрана цель для атаки белой стрелы: '.$index_to.'<br>'; }
    if($sh[$index+48]>0 && $sh[$index+48]<10) { $index_to=$index+48; echo 'Выбрана цель для атаки белой стрелы: '.$index_to.'<br>'; }
    if($sh[$index-2]>0 && $sh[$index-2]<10) { $index_to=$index-2; echo 'Выбрана цель для атаки белой стрелы: '.$index_to.'<br>'; }
