...
<br><div class="cell2" id="">7</div>
  <? $x=$x+'17'; ?><div class="cell dark" id="A7" style="background-color:<? echo $color_b[$x]; ?>"><img src="<?echo $arImages[$sh[$x]]?>" title="<? echo $alt[$x]; ?>" <? echo 'width='.$width; echo 'height='.$height; ?>></div>
...
<div class="cell2" id="">6</div>
  ...
  <? $x=$x+'17'; ?><div class="cell" id="A6" style="background-color:<? echo $color_b[$x]; ?>"><img src="<?echo $arImages[$sh[$x]]?>" title="<? echo $alt[$x]; ?>" <? echo 'width='.$width; echo 'height='.$height; ?>></div>
...
<div class="cell2" id="">5</div>
  ...
  <? $x=$x+'17'; ?><div class="cell dark" id="A5" style="background-color:<? echo $color_b[$x]; ?>"><img src="<?echo $arImages[$sh[$x]]?>" title="<? echo $alt[$x]; ?>" <? echo 'width='.$width; echo 'height='.$height; ?>></div>
...
<div class="cell2" id="">4</div>
  ...
  <? $x=$x+'17'; ?><div class="cell" id="A4" style="background-color:<? echo $color_b[$x]; ?>"><img src="<?echo $arImages[$sh[$x]]?>" title="<? echo $alt[$x]; ?>" <? echo 'width='.$width; echo 'height='.$height; ?>></div>
...
<div class="cell2" id="">3</div>
  ...
  <? $x=$x+'17'; ?><div class="cell dark" id="A3" style="background-color:<? echo $color_b[$x]; ?>"><img src="<?echo $arImages[$sh[$x]]?>" title="<? echo $alt[$x]; ?>" <? echo 'width='.$width; echo 'height='.$height; ?>></div>
...
<div class="cell2" id="">2</div>
  ...
  <? $x=$x+'17'; ?><div class="cell" id="A2" style="background-color:<? echo $color_b[$x]; ?>"><img src="<?echo $arImages[$sh[$x]]?>" title="<? echo $alt[$x]; ?>" <? echo 'width='.$width; echo 'height='.$height; ?>></div>
...
<div class="cell2" id="">1</div>
  ...
  <? $x=$x+'17'; ?><div class="cell dark" id="A1" style="background-color:<? echo $color_b[$x]; ?>"><img src="<?echo $arImages[$sh[$x]]?>" title="<? echo $alt[$x]; ?>" <? echo 'width='.$width; echo 'height='.$height; ?>></div>
