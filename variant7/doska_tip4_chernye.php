...
<div id="table">
  ...
  <div class="cell" id="H1" style="background-color:<? echo $color_b[$x]; ?>"><img src="<?echo $arImages[$sh[$x]]?>" title="<? echo $alt[$x]; ?>" <? echo 'width='.$width; echo 'height='.$height; ?>></div>
   ...
   <? $x=$x-'17'; ?><div class="cell dark" id="H2" style="background-color:<? echo $color_b[$x]; ?>"><img src="<?echo $arImages[$sh[$x]]?>" title="<? echo $alt[$x]; ?>" <? echo 'width='.$width; echo 'height='.$height; ?>></div>
   ...
   <? $x=$x-'17'; ?><div class="cell" id="H3" style="background-color:<? echo $color_b[$x]; ?>"><img src="<?echo $arImages[$sh[$x]]?>" title="<? echo $alt[$x]; ?>" <? echo 'width='.$width; echo 'height='.$height; ?>></div>
   ...
   <? $x=$x-'17'; ?><div class="cell dark" id="H4" style="background-color:<? echo $color_b[$x]; ?>"><img src="<?echo $arImages[$sh[$x]]?>" title="<? echo $alt[$x]; ?>" <? echo 'width='.$width; echo 'height='.$height; ?>></div>
   ...
   <? $x=$x-'17'; ?><div class="cell" id="H5" style="background-color:<? echo $color_b[$x]; ?>"><img src="<?echo $arImages[$sh[$x]]?>" title="<? echo $alt[$x]; ?>" <? echo 'width='.$width; echo 'height='.$height; ?>></div>
   ...
   <? $x=$x-'17'; ?><div class="cell dark" id="H6" style="background-color:<? echo $color_b[$x]; ?>"><img src="<?echo $arImages[$sh[$x]]?>" title="<? echo $alt[$x]; ?>" <? echo 'width='.$width; echo 'height='.$height; ?>></div>
   ...
   <? $x=$x-'17'; ?><div class="cell" id="H7" style="background-color:<? echo $color_b[$x]; ?>"><img src="<?echo $arImages[$sh[$x]]?>" title="<? echo $alt[$x]; ?>" <? echo 'width='.$width; echo 'height='.$height; ?>></div>
   ...
   <? $x=$x-'17'; ?><div class="cell dark" id="H8" style="background-color:<? echo $color_b[$x]; ?>"><img src="<?echo $arImages[$sh[$x]]?>" title="<? echo $alt[$x]; ?>" <? echo 'width='.$width; echo 'height='.$height; ?>></div>
