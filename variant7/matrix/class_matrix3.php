...
if($prov!='1' & $prov!='-1' & $prov!='2' & $prov!='-2' &
 $prov!='24' & $prov!='-24' & $prov!='48' & $prov!='-48') { echo '<br>Дракон бьёт по другому = ['.$prov.']'; $hod_one='1000'; $hod_two='1000'; }

                                                  } else if($sh[$hod_two]=='40' || $sh[$hod_two]=='81' || $sh[$hod_two]=='82' || $sh[$hod_two]=='83') {

if($prov!='23' & $prov!='-23' & $prov!='25' & $prov!='-25' &
 $prov!='26' & $prov!='-26' & $prov!='22' & $prov!='-22' &
 $prov!='47' & $prov!='-47' & $prov!='49' & $prov!='-49') { echo '<br>Дракон ходит по другому = ['.$prov.']'; $hod_one='1000'; $hod_two='1000'; }
...
if($prov!='3' & $prov!='-3' & $prov!='72' & $prov!='-72' &
 $prov!='47' & $prov!='-47' & $prov!='49' & $prov!='-49' &
 $prov!='22' & $prov!='-22' & $prov!='26' & $prov!='-26') { echo '<br>Стрела бьёт по другому = ['.$prov.']'; $hod_one='1000'; $hod_two='1000'; }

                                                  } else if($sh[$hod_two]=='40' || $sh[$hod_two]=='81' || $sh[$hod_two]=='82' || $sh[$hod_two]=='83') {

if($prov!='2' & $prov!='-2' & $prov!='46' & $prov!='-46' &
 $prov!='48' & $prov!='-48' & $prov!='50' & $prov!='-50') { echo '<br>Стрела ходит по другому = ['.$prov.']'; $hod_one='1000'; $hod_two='1000'; }
...
if($prov!='22' & $prov!='-22' & $prov!='26' & $prov!='-26' &
 $prov!='47' & $prov!='-47' & $prov!='49' & $prov!='-49') { echo '<br>Отшельник бьёт по другому = ['.$prov.']'; $hod_one='1000'; $hod_two='1000'; }

                                                  } else if($sh[$hod_two]=='40' || $sh[$hod_two]=='81' || $sh[$hod_two]=='82' || $sh[$hod_two]=='83') {

if($prov!='46' & $prov!='-46' & $prov!='50' & $prov!='-50' &
 $prov!='23' & $prov!='-23' & $prov!='25' & $prov!='-25') { echo '<br>Отшельник ходит по другому = ['.$prov.']'; $hod_one='1000'; $hod_two='1000'; }
...
if($hod_one!='58' & $hod_one!='226') {        // если ходит король, если не исходная позиция 
