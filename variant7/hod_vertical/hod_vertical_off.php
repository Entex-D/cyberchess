...
$sxx1='./archive_doski/'.$doska.'/tip7/'.$nomer_doski7.'/'.$nomer_doski7.'_hod_vartical_off.txt';
...
$data_x='./archive_doski/'.$doska.'/tip7/'.$nomer_doski7.'/'.$nomer_doski7.'_hod_vartical_off.txt';
...
$data1='./archive_doski/'.$doska.'/tip7/'.$nomer_doski7.'/'.$nomer_doski7.'_hod_vartical_off.txt';
