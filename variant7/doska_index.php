...
if(!$nomer7 && isset($_COOKIE['nomer_doski7'])) { //echo '<br>считан номер доски='.$nomer_doski7;
  ...
  if($game!='5' && $game>'0' && !isset($_COOKIE['nomer_doski7'])) {
  
   include('./ochki/vsego_igr_write.php'); 

$fx=rand(1,10000); $nomer_doski7='a'.$fx.'g'; 
if(setcookie ("nomer_doski7", $nomer_doski7, time() + 3600*24*700)) { //echo '<br>куки не записались'; 
} 
                                                               }
...
if(isset($_COOKIE['doska_kuki_nomer7']))  { $doska=$doska_kuki_nomer7; }
...
fclose ($file);
              ...
              if($game<'5' && $game>'0' && !isset($_COOKIE['nomer_doski7'])) { echo ''; 
...
$sh[198]='14';$sh[198-24]='11';
$sh[199]='11';$sh[199-24]='13';
$sh[200]='11';
$sh[201]='11';
$sh[202]='11';
$sh[203]='11';
$sh[204]='11';$sh[204-24]='13';
$sh[205]='14';$sh[205-24]='11';
//$sh[206]='19';
//$sh[207]='11';
//$sh[208]='19';
//$sh[209]='11';  
...
if($name==$doska) { //$fx=rand(1,10000); $nomer_doski7='n'.$fx.'r'; 
//if(!setcookie ("nomer_doski7", $nomer_doski7, time() + 3600*24*700)) { echo '<br>куки не записались'; } 

$adres='./archive_doski/'.$name.'/tip7/'.$nomer_doski7;
...
//echo '<br>$doska='.$doska;
//echo '<br>$name='.$name;
//echo '<br>$nomer_doski7='.$nomer_doski7;

$figury='./archive_doski/'.$name.'/tip7/'.$nomer_doski7.'/'.$nomer_doski7.'.txt';
...
$dannye_archive='./archive_doski/'.$name.'/tip7/'.$nomer_doski7.'/'.$nomer_doski7.'_statix.txt';
...
$logi_text='<font size=1><em>'.date("d.m.Y|G:i:s ").'</em></font> Игрок <strong><em>'.$name.'</em></strong> создал  новую игру '.$game_g.' на доске '.$nomer_doski7.' вариант #7 Ставка '.$dixa20.' btc';
...
if($game=='5' && isset($_COOKIE['nomer_doski7'])) { echo ''; 

$logi='logi.txt';

$logi_text='<font size=1><em>'.date("d.m.Y|G:i:s ").'</em></font> Игрок <strong><em>'.$name.'</em></strong> отменил игру на доске '.$nomer_doski7.' вариант #7';
$openchatdb=fopen($logi,"a");
 if(fwrite($openchatdb,$logi_text."\n")) { ;  }
fclose($openchatdb);
...
//echo '$nomer_doski7='.$nomer_doski7;
...
<? if($name==$exxo[4] && $nomer_doski7 && $exxo[5]=='0' && $exxo[18]=='0') { echo '';  ?>
...
echo '<br><a href=index.php?doska='.$doska.'&tip=3&nomer_doski7='.$nomer_doski7.'&ilost=yes>Сдаться</a>'; 
 }}
...
<? if($name==$exxo[3] && $nomer_doski7 && $exxo[5]=='0' && $exxo[18]=='0') {  // если играем белыми - доска в своем положении
?>
...
<? 
      echo '<center><strong>Уран 12x8</strong></center><br><br><font size=2><strong><center>';
?>

<a target=_blank href=model_game/variant7-igra1-style<? echo $style_run; ?>.jpg><img src=model_game/variant7-igra1-style<? echo $style_run; ?>.jpg width=30% /></a>

<? echo '<br><br><br>Создайте новую игру '.$name.'</center></strong></font></td>';
      //include('prosmotr_doski.php');
  } else if($nomer_doski7 && $name!=$exxo[3] && $name!=$exxo[4] && $exxo[18]=='0' && $exxo[1]!='Comp') {
 
      echo '<font size=4><strong><center>Доска '.$nomer_doski7.' занята,создайте свою игру '.$name.'</center></strong></font>';
      echo '<font size=2><strong><em><center>
Посмотреть партию <a target=_blank href=variant7/archive_d_tip4_uvel.php?namer='.$doska.'&tip=7&nomer7='.$nomer_doski7.'>в архиве</a>
</center></em></strong></font></td>';
      //include('prosmotr_doski.php'); 

} else if($exxo[18]=='Отменена') {

     echo '<font size=4><strong><center>Доска '.$nomer_doski7.' отменена,игроком '.$doska.'</center></strong></font>
               <font size=2><strong><em><center>Посмотреть доску '.$nomer_doski7.' <a target=_blank href=variant7/archive_d_tip4_uvel.php?namer='.$doska.'&tip=7&nomer7='.$nomer_doski7.'>в архиве</a></center></em></strong></font>
</td>';
    //  include('prosmotr_doski.php'); 

if($exxo[5]!='0' || $exxo[18]!='0') {  
 $nomer_doski7='';  setcookie ("nomer_doski7", $nomer_doski7, time() + 1);
$nomer7='';  setcookie ("nomer7", $nomer7, time() + 1); 
}
...
if($exxo[5]==$name) {
     echo '<font size=4><strong><center>Вы выиграли играя '.$d.', '.$bex.' проиграл</center></strong></font>';
               ...
               echo '<font size=2><strong><em><center>Посмотреть доску '.$nomer_doski7.' <a target=_blank href=variant7/archive_d_tip4_uvel.php?namer='.$doska.'&tip7=7&nomer7='.$nomer_doski7.'>в архиве</a></center></em></strong></font>';
...
$data1='./archive_doski/'.$doska.'/tip7/'.$nomer_doski7.'/'.$nomer_doski7.'_hod_vartical_white.txt';
...
if($exxo[21]>'9' || $exxo[22]>'9') {
 include('./variant7/hod_vertical/hod_vertical.php'); 
                                                    }
}
...
if($exxo[21]>'9' || $exxo[22]>'9') {
 include('./variant7/random_figura/hod_vertical.php'); 
                                                    }
} 
 ...
 include('./variant7/hod_vertical/random_table.php'); 
...
if($zvuki_hody=='11') { 
 ...
 if($exxo[12]<2) { include('./variant7/zvuk_start_game.php'); } 
if($exxo[12]>1 && $exxo[12]!=10) { include('./variant7/zvuk.php'); }
