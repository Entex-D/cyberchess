...
$sxx1='./archive_doski/'.$doska.'/tip6/'.$nomer_doski6.'/'.$nomer_doski6.'_hod_vartical_off.txt';
...
$data_x='./archive_doski/'.$doska.'/tip6/'.$nomer_doski6.'/'.$nomer_doski6.'_hod_vartical_off.txt';
...
$data1='./archive_doski/'.$doska.'/tip6/'.$nomer_doski6.'/'.$nomer_doski6.'_hod_vartical_off.txt';
