...
$prov!='46' & $prov!='-46' & $prov!='50' & $prov!='-50') { echo '<br>Insider бьёт по другому = ['.$prov.']'; $hod_one='1000'; $hod_two='1000'; }

                                                  } else if($sh[$hod_two]=='40' || $sh[$hod_two]=='81' || $sh[$hod_two]=='82' || $sh[$hod_two]=='83') {

if($prov!='23' & $prov!='-23' & $prov!='25' & $prov!='-25' &
 $prov!='2' & $prov!='-2' & $prov!='48' & $prov!='-48') { echo '<br>Insider ходит по другому = ['.$prov.']'; $hod_one='1000'; $hod_two='1000'; }
...
if($prov!='23' & $prov!='-23' & $prov!='25' & $prov!='-25' &
 $prov!='46' & $prov!='-46' & $prov!='50' & $prov!='-50' &
 $prov!='69' & $prov!='-69' & $prov!='75' & $prov!='-75') { echo '<br>Гений бьёт по другому = ['.$prov.']'; $hod_one='1000'; $hod_two='1000'; }

                                                  } else if($sh[$hod_two]=='40' || $sh[$hod_two]=='81' || $sh[$hod_two]=='82' || $sh[$hod_two]=='83') {

if($prov!='24' & $prov!='-24' & $prov!='47' & $prov!='-47' &
 $prov!='49' & $prov!='-49' & $prov!='70' & $prov!='-70' & $prov!='74' & $prov!='-74') { echo '<br>Гений ходит по другому = ['.$prov.']'; $hod_one='1000'; $hod_two='1000'; }
...
if($prov!='2' & $prov!='-2' & $prov!='48' & $prov!='-48' &
 $prov!='22' & $prov!='-22' & $prov!='26' & $prov!='-26' &
 $prov!='47' & $prov!='-47' & $prov!='49' & $prov!='-49') { echo '<br>Паук бьёт по другому = ['.$prov.']'; $hod_one='1000'; $hod_two='1000'; }

                                                  } else if($sh[$hod_two]=='40' || $sh[$hod_two]=='81' || $sh[$hod_two]=='82' || $sh[$hod_two]=='83') {

if($prov!='23' & $prov!='-23' & $prov!='25' & $prov!='-25' &
 $prov!='2' & $prov!='-2' & $prov!='48' & $prov!='-48') { echo '<br>Паук ходит по другому = ['.$prov.']'; $hod_one='1000'; $hod_two='1000'; }
