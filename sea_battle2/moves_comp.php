...
//if($tt=='3') {  if($fexo[$rr-15]!='98' && $fexo[$rr-15]!='99') { $hod_one=$rr-'15'; $zet='2'; }  }
//if($tt=='4') {  if($fexo[$rr+15]!='98' && $fexo[$rr+15]!='99') { $hod_one=$rr+'15'; $zet='2'; }  }
...
if($fexo[$hod_one]!='40') { $fexo[$hod_one]='98'; 
 if($fexo[$hod_one+'1']<'5' || $fexo[$hod_one-'1']<'5' || $fexo[$hod_one-'15']<'5' || $fexo[$hod_one+'15']<'5') { 
...
$write='../sea_battle2/igrok/'.$nick.'_figure.txt';
