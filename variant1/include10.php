...
if($sopernik) { if($nomer || $nomer_doski) { unset($nomer);  unset($nomer_doski);
                              setcookie ("nomer", $nomer, time() );  setcookie ("nomer_doski", $nomer_doski, time() );         }
                   }
...
if(!file_exists($sxx))   {  //echo 'файл '.$sxx.' присутствует';
                          ...
                          setcookie ("nomer_doski", $nomer_doski, time() + 1);
                          setcookie ("nomer", $nomer, time() + 1);
                     ?>
...
if($_POST['sbros']) { 
//$game='5'; 
//$nomer_rezet=''; $nomer=$nomer_rezet;
setcookie ("game", $game, time() + 4);
 setcookie ("nomer_doski", $nomer_doski, time());  
 setcookie ("nomer", $nomer, time());  
...
setcookie ("game", $game, time() + 4);
 setcookie ("nomer_doski", $nomer_doski, time() + 1);  
// setcookie ("nomer", $nomer,4 time() + 1);  
 setcookie ("timer", $timer, time() + 1);  
setcookie ("btc", $btc, time() + 1);  
$rrt='4'; 
...
if($nomer>' ') {  setcookie ("nomer", $nomer, time() +3600);  }

//если нет своей игры,и открываю свою игру из оповещений
if(!$nomer_doski && $nomer) { $nomer_doski=$nomer; setcookie ("nomer_doski", $nomer_doski, time() +3600*24*700); }
