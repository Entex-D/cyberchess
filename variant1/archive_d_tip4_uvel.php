...
<table width=90%><tr>
<td class=td_center><center><font size=4><br><strong><a href=#>[[</a> Просмотр доски <? echo $nomer; ?> игрока <? echo $namer; ?> <a href=#>]]</a></strong><br></font></center></td></tr></table>
...
$ndoski='../archive_doski/'.$namer.'/tip1/'.$nomer.'/'.$nomer.'_hody.txt';
 $b4='0';
...
$fdoski='../archive_doski/'.$namer.'/tip1/'.$nomer.'/'.$nomer.'.txt';
 $b5='0';
...
$fstatix='../archive_doski/'.$namer.'/tip1/'.$nomer.'/'.$nomer.'_statix.txt';
 $b6='0';
...
<? include('../variant1/shah.php'); ?>
<? if($zvuki_hody=='11') { include('../variant1/zvuk_uvel.php'); } ?>
...
<? echo '&nbsp;&nbsp;&nbsp;&nbsp;Правила на доске '.$nomer.', игрока '.$namer.':'; ?>
</strong><br><br></font>
...
<meta http-equiv='refresh' content='40;url=archive_d_tip4_uvel.php?namer=<? echo $namer; ?>&tip=1&nomer=<? echo $nomer; ?>'>
