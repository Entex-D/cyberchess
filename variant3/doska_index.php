...
if(!$nomer3 && isset($_COOKIE['nomer_doski3'])) { //echo '<br>считан номер доски='.$nomer_doski3;
  ...
  if($game!='5' && $game>'0' && !isset($_COOKIE['nomer_doski3'])) {
  
   include('./ochki/vsego_igr_write.php'); 

$fx=rand(1,10000); $nomer_doski3='a'.$fx.'c'; 
if(setcookie ("nomer_doski3", $nomer_doski3, time() + 3600*24*700)) { //echo '<br>куки не записались'; 
} 
                                                               }
...
if(isset($_COOKIE['doska_kuki_nomer3']))  { $doska=$doska_kuki_nomer3; }
...
include('./variant3/config_type4.php');
...
fclose ($file);
              ...
              if($game<'5' && $game>'0' && !isset($_COOKIE['nomer_doski3'])) { echo ''; 
...
$sh[80]='7';$sh[80+24]='1';
$sh[81]='4';
$sh[83]='3';$sh[82+24]='9';$sh[82+24+24]='1';
$sh[83+24]='1';
$sh[84+24]='1';
$sh[84]='3';$sh[85+24]='9';$sh[85+24+24]='1';
$sh[86]='4';
$sh[87]='7';$sh[87+24]='1';
$sh[88]='9';
$sh[89]='8';$sh[89+24]='1';
...
$sh[198]='18';$sh[198-24]='11';
$sh[199]='19';
$sh[200]='17';$sh[200-24]='11';
$sh[201]='14';
$sh[203]='13';$sh[202-24]='19';$sh[202-24-24]='11';
$sh[203-24]='11';
$sh[204-24]='11';
$sh[204]='13';$sh[205-24]='19';$sh[205-24-24]='11';
$sh[206]='14';
$sh[207]='17';$sh[207-24]='11';
$sh[208]='19';
$sh[209]='18';$sh[209-24]='11';
...
if($name==$doska) { //$fx=rand(1,10000); $nomer_doski3='n'.$fx.'r'; 
//if(!setcookie ("nomer_doski3", $nomer_doski3, time() + 3600*24*700)) { echo '<br>куки не записались'; } 

$adres='./archive_doski/'.$name.'/tip3/'.$nomer_doski3;
...
//echo '<br>$doska='.$doska;
//echo '<br>$name='.$name;
//echo '<br>$nomer_doski3='.$nomer_doski3;

$figury='./archive_doski/'.$name.'/tip3/'.$nomer_doski3.'/'.$nomer_doski3.'.txt';
...
$dannye_archive='./archive_doski/'.$name.'/tip3/'.$nomer_doski3.'/'.$nomer_doski3.'_statix.txt';
...
$logi_text='<font size=1><em>'.date("d.m.Y|G:i:s ").'</em></font> Игрок <strong><em>'.$name.'</em></strong> создал  новую игру '.$game_g.' на доске '.$nomer_doski3.' вариант #3 Ставка '.$dixa20.' btc';
...
if($game=='5' && isset($_COOKIE['nomer_doski3'])) { echo ''; 

$logi='logi.txt';

$logi_text='<font size=1><em>'.date("d.m.Y|G:i:s ").'</em></font> Игрок <strong><em>'.$name.'</em></strong> отменил игру на доске '.$nomer_doski3.' вариант #3';
$openchatdb=fopen($logi,"a");
 if(fwrite($openchatdb,$logi_text."\n")) { ;  }
fclose($openchatdb);
...
//echo '$nomer_doski3='.$nomer_doski3;

if($nomer_doski3) {

$sxx='./archive_doski/'.$doska.'/tip3/'.$nomer_doski3.'/'.$nomer_doski3.'_statix.txt';
...
// считываем типа $nomer3 и перезаписываем игрока 2 в файл,чтобы показалась доска для 2 игрока
...
// конец считываем типа $nomer3 и перезаписываем игрока 2 в файл,чтобы показалась доска для 2 игрока
?>
...
<? if($name==$exxo[4] && $nomer_doski3 && $exxo[5]=='0' && $exxo[18]=='0') { echo '';  ?>
...
if($exxo[1]!='Comp') { echo '<br><a href=index.php?doska='.$doska.'&tip=3&nomer_doski3='.$nomer_doski3.'&ilost=yes>Сдаться</a>'; } 
 }}
...
<? if($name==$exxo[3] && $nomer_doski3 && $exxo[5]=='0' && $exxo[18]=='0') {  // если играем белыми - доска в своем положении
?>
...
echo '<br><a href=index.php?doska='.$doska.'&tip=3&nomer_doski3='.$nomer_doski3.'&ilost=yes>Сдаться</a>'; 
 }}
// конец обновление вместо "онлайн людей" от 15.06.2020
?>
...
<? 
      echo '<center><strong>Земля 12x8</strong></center><br><br><font size=2><strong><center>';
?>

<a target=_blank href=model_game/variant3-igra1-style<? echo $style_run; ?>.jpg><img src=model_game/variant3-igra1-style<? echo $style_run; ?>.jpg width=30% /></a>

<? echo '<br><br><br>Создайте новую игру '.$name.'</center></strong></font></td>';
      //include('prosmotr_doski.php');
  } else if($nomer_doski3 && $name!=$exxo[3] && $name!=$exxo[4] && $exxo[18]=='0' && $exxo[1]!='Comp') {
 
      echo '<font size=4><strong><center>Доска '.$nomer_doski3.' занята,создайте свою игру '.$name.'</center></strong></font>';
      echo '<font size=2><strong><em><center>
Посмотреть партию <a target=_blank href=variant3/archive_d_tip4_uvel.php?namer='.$doska.'&tip3=3&nomer3='.$nomer_doski3.'>в архиве</a>
</center></em></strong></font></td>';
      //include('prosmotr_doski.php'); 

} else if($exxo[18]=='Отменена') {

     echo '<font size=4><strong><center>Доска '.$nomer_doski3.' отменена,игроком '.$doska.'</center></strong></font>
               <font size=2><strong><em><center>Посмотреть доску '.$nomer_doski3.' <a target=_blank href=variant3/archive_d_tip4_uvel.php?namer='.$doska.'&tip3=3&nomer3='.$nomer_doski3.'>в архиве</a></center></em></strong></font>
</td>';
    //  include('prosmotr_doski.php'); 

if($exxo[5]!='0' || $exxo[18]!='0') {  
 $nomer_doski3='';  setcookie ("nomer_doski3", $nomer_doski3, time() + 1);
$nomer3='';  setcookie ("nomer3", $nomer3, time() + 1); 
}
...
if($exxo[5]==$name) {
     echo '<font size=4><strong><center>Вы выиграли играя '.$d.', '.$bex.' проиграл</center></strong></font>';
               ...
               echo '<font size=2><strong><em><center>Посмотреть доску '.$nomer_doski3.' <a target=_blank href=variant3/archive_d_tip4_uvel.php?namer='.$doska.'&tip3=3&nomer3='.$nomer_doski3.'>в архиве</a></center></em></strong></font>';
...
<tr>
<td bgcolor=<? echo $color_x; ?>><center>Стрела</center></td>
<td bgcolor=<? echo $color_x; ?>><center><? echo $figure_dx8_coord; ?> <? echo $figure_dx8x_coord; ?></center></td>
<td bgcolor=<? echo $color_x; ?>><center><a target=_blank href=../model_game/<? echo $fixxa; ?>pravila_strela.jpg>Правила ходов у Стрелы</a></center></td>
</tr>

<tr>
<td bgcolor=<? echo $color_x; ?>><center>Дракон</center></td>
<td bgcolor=<? echo $color_x; ?>><center><? echo $figure_dx7_coord; ?> <? echo $figure_dx7x_coord; ?></center></td>
<td bgcolor=<? echo $color_x; ?>><center><a target=_blank href=../model_game/<? echo $fixxa; ?>pravila_dracon_tip8.jpg>Правила ходов у Дракона</a></center></td>
</tr>

<tr>
<td bgcolor=<? echo $color_x; ?>><center>Отшельник</center></td>
<td bgcolor=<? echo $color_x; ?>><center><? echo $figure_dx9_coord; ?> <? echo $figure_dx9x_coord; ?></center></td>
<td bgcolor=<? echo $color_x; ?>><center><a target=_blank href=../model_game/<? echo $fixxa; ?>pravila_otshelnik.jpg>Правила ходов у Отшельника</a></center></td>
</tr>
...
$data1='./archive_doski/'.$doska.'/tip3/'.$nomer_doski3.'/'.$nomer_doski3.'_hod_vartical_white.txt';
 
if ( !file_exists($data1) ) { 

 include('./variant3/hod_vertical/hod_vertical_create.php'); 

}

include('./variant3/hod_vertical/hod_vertical_off.php'); ?>
<? if($exxo[11] && $shah!='1' && $shah!='2' && $shah_off[0]!='1' && $shah_off[1]=='1') { 


if($exxo[21]>'9' || $exxo[22]>'9') {
 include('./variant3/hod_vertical/hod_vertical.php'); 
                                                    }
}
...
if ( !file_exists($data1) ) { 
 ...
 include('./variant3/random_figura/hod_vertical_create.php'); 
...
if($exxo[21]>'9' || $exxo[22]>'9') {
 include('./variant3/random_figura/hod_vertical.php'); 
                                                    }
} 
 ...
 include('./variant3/hod_vertical/random_table.php'); 
...
if($zvuki_hody=='11') { 
 ...
 if($exxo[12]<2) { include('./variant3/zvuk_start_game.php'); } 
if($exxo[12]>1 && $exxo[12]!=11) { include('./variant3/zvuk.php'); }
