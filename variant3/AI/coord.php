...
if($index_to) {  $hod_one=$index; $hod_two=$index_to; }
  ...
  if($index_to) {  $hod_one=$index; $hod_two=$index_to; }
    ...
    if($sh[$index+3]>10 && $sh[$index+3]<20) { $index_to=$index+2; echo 'Выбрана цель для атаки черной стрелы: '.$index_to.'<br>'; }
    if($sh[$index-3]>10 && $sh[$index-3]<20) { $index_to=$index-48; echo 'Выбрана цель для атаки черной стрелы: '.$index_to.'<br>'; }
    if($sh[$index+72]>10 && $sh[$index+72]<20) { $index_to=$index+48; echo 'Выбрана цель для атаки черной стрелы: '.$index_to.'<br>'; }
    if($sh[$index-72]>10 && $sh[$index-72]<20) { $index_to=$index-2; echo 'Выбрана цель для атаки черной стрелы: '.$index_to.'<br>'; }
    if($sh[$index+22]>10 && $sh[$index+22]<20) { $index_to=$index+22; echo 'Выбрана цель для атаки черной стрелы: '.$index_to.'<br>'; }
    if($sh[$index+26]>10 && $sh[$index+26]<20) { $index_to=$index+26; echo 'Выбрана цель для атаки черной стрелы: '.$index_to.'<br>'; }
    if($sh[$index-22]>10 && $sh[$index-22]<20) { $index_to=$index-22; echo 'Выбрана цель для атаки черной стрелы: '.$index_to.'<br>'; }
    if($sh[$index-26]>10 && $sh[$index-26]<20) { $index_to=$index-26; echo 'Выбрана цель для атаки черной стрелы: '.$index_to.'<br>'; }
    if($sh[$index+47]>10 && $sh[$index+47]<20) { $index_to=$index+47; echo 'Выбрана цель для атаки черной стрелы: '.$index_to.'<br>'; }
    if($sh[$index+49]>10 && $sh[$index+49]<20) { $index_to=$index+49; echo 'Выбрана цель для атаки черной стрелы: '.$index_to.'<br>'; }
    if($sh[$index-47]>10 && $sh[$index-47]<20) { $index_to=$index-47; echo 'Выбрана цель для атаки черной стрелы: '.$index_to.'<br>'; }
    if($sh[$index-49]>10 && $sh[$index-49]<20) { $index_to=$index-49; echo 'Выбрана цель для атаки черной стрелы: '.$index_to.'<br>'; }
...
if($index_to) {  $hod_one=$index; $hod_two=$index_to; }
    ...
    if($sh[$index+3]>0 && $sh[$index+3]<10) { $index_to=$index+2; echo 'Выбрана цель для атаки белой стрелы: '.$index_to.'<br>'; }
    if($sh[$index-3]>0 && $sh[$index-3]<10) { $index_to=$index-48; echo 'Выбрана цель для атаки белой стрелы: '.$index_to.'<br>'; }
    if($sh[$index+72]>0 && $sh[$index+72]<10) { $index_to=$index+48; echo 'Выбрана цель для атаки белой стрелы: '.$index_to.'<br>'; }
    if($sh[$index-72]>0 && $sh[$index-72]<10) { $index_to=$index-2; echo 'Выбрана цель для атаки белой стрелы: '.$index_to.'<br>'; }
    if($sh[$index+22]>0 && $sh[$index+22]<10) { $index_to=$index+22; echo 'Выбрана цель для атаки белой стрелы: '.$index_to.'<br>'; }
    if($sh[$index+26]>0 && $sh[$index+26]<10) { $index_to=$index+26; echo 'Выбрана цель для атаки белой стрелы: '.$index_to.'<br>'; }
    if($sh[$index-22]>0 && $sh[$index-22]<10) { $index_to=$index-22; echo 'Выбрана цель для атаки белой стрелы: '.$index_to.'<br>'; }
    if($sh[$index-26]>0 && $sh[$index-26]<10) { $index_to=$index-26; echo 'Выбрана цель для атаки белой стрелы: '.$index_to.'<br>'; }
    if($sh[$index+47]>0 && $sh[$index+47]<10) { $index_to=$index+47; echo 'Выбрана цель для атаки белой стрелы: '.$index_to.'<br>'; }
    if($sh[$index+49]>0 && $sh[$index+49]<10) { $index_to=$index+49; echo 'Выбрана цель для атаки белой стрелы: '.$index_to.'<br>'; }
    if($sh[$index-47]>0 && $sh[$index-47]<10) { $index_to=$index-47; echo 'Выбрана цель для атаки белой стрелы: '.$index_to.'<br>'; }
    if($sh[$index-49]>0 && $sh[$index-49]<10) { $index_to=$index-49; echo 'Выбрана цель для атаки белой стрелы: '.$index_to.'<br>'; }
  ...
  if($index_to) {  $hod_one=$index; $hod_two=$index_to; }
    ...
    if($sh[$index+2]>10 && $sh[$index+2]<20) { $index_to=$index+2; echo 'Выбрана цель для атаки черного дракона: '.$index_to.'<br>'; }
    if($sh[$index-1]>10 && $sh[$index-1]<20) { $index_to=$index-1; echo 'Выбрана цель для атаки черного дракона: '.$index_to.'<br>'; }
    if($sh[$index+1]>10 && $sh[$index+1]<20) { $index_to=$index+1; echo 'Выбрана цель для атаки черного дракона: '.$index_to.'<br>'; }
    if($sh[$index-2]>10 && $sh[$index-2]<20) { $index_to=$index-2; echo 'Выбрана цель для атаки черного дракона: '.$index_to.'<br>'; }
    if($sh[$index+24]>10 && $sh[$index+24]<20) { $index_to=$index+24; echo 'Выбрана цель для атаки черного дракона: '.$index_to.'<br>'; }
    if($sh[$index+48]>10 && $sh[$index+48]<20) { $index_to=$index+48; echo 'Выбрана цель для атаки черного дракона: '.$index_to.'<br>'; }
    if($sh[$index-24]>10 && $sh[$index-24]<20) { $index_to=$index-24; echo 'Выбрана цель для атаки черного дракона: '.$index_to.'<br>'; }
    if($sh[$index-48]>10 && $sh[$index-48]<20) { $index_to=$index-48; echo 'Выбрана цель для атаки черного дракона: '.$index_to.'<br>'; }
...
if($index_to) {  $hod_one=$index; $hod_two=$index_to; }
    ...
    if($sh[$index] == 17 && $exxo[3]=='Comp' && $exxo[11]=='Белые') { // Черная пешка
        ...
        if($sh[$index+2]>0 && $sh[$index+2]<10) { $index_to=$index+2; echo 'Выбрана цель для атаки белого дракона: '.$index_to.'<br>'; }
    if($sh[$index-1]>0 && $sh[$index-1]<0) { $index_to=$index-1; echo 'Выбрана цель для атаки белого дракона: '.$index_to.'<br>'; }
    if($sh[$index+1]>0 && $sh[$index+1]<0) { $index_to=$index+1; echo 'Выбрана цель для атаки белого дракона: '.$index_to.'<br>'; }
    if($sh[$index-2]>0 && $sh[$index-2]<0) { $index_to=$index-2; echo 'Выбрана цель для атаки белого дракона: '.$index_to.'<br>'; }
    if($sh[$index+24]>0 && $sh[$index+24]<0) { $index_to=$index+24; echo 'Выбрана цель для атаки белого дракона: '.$index_to.'<br>'; }
    if($sh[$index+48]>0 && $sh[$index+48]<0) { $index_to=$index+48; echo 'Выбрана цель для атаки белого дракона: '.$index_to.'<br>'; }
    if($sh[$index-24]>0 && $sh[$index-24]<0) { $index_to=$index-24; echo 'Выбрана цель для атаки белого дракона: '.$index_to.'<br>'; }
    if($sh[$index-48]>0 && $sh[$index-48]<0) { $index_to=$index-48; echo 'Выбрана цель для атаки белого дракона: '.$index_to.'<br>'; }
  ...
  if($index_to) {  $hod_one=$index; $hod_two=$index_to; }
    ...
    if($sh[$index+22]>10 && $sh[$index+22]<20) { $index_to=$index+22; echo 'Выбрана цель для атаки черного отшельника: '.$index_to.'<br>'; }
    if($sh[$index+26]>10 && $sh[$index+26]<20) { $index_to=$index+26; echo 'Выбрана цель для атаки черного отшельника: '.$index_to.'<br>'; }
    if($sh[$index-22]>10 && $sh[$index-22]<20) { $index_to=$index-22; echo 'Выбрана цель для атаки черного отшельника: '.$index_to.'<br>'; }
    if($sh[$index-26]>10 && $sh[$index-26]<20) { $index_to=$index-26; echo 'Выбрана цель для атаки черного отшельника: '.$index_to.'<br>'; }
    if($sh[$index+47]>10 && $sh[$index+47]<20) { $index_to=$index+47; echo 'Выбрана цель для атаки черного отшельника: '.$index_to.'<br>'; }
    if($sh[$index+49]>10 && $sh[$index+49]<20) { $index_to=$index+49; echo 'Выбрана цель для атаки черного отшельника: '.$index_to.'<br>'; }
    if($sh[$index-47]>10 && $sh[$index-47]<20) { $index_to=$index-47; echo 'Выбрана цель для атаки черного отшельника: '.$index_to.'<br>'; }
    if($sh[$index-49]>10 && $sh[$index-49]<20) { $index_to=$index-49; echo 'Выбрана цель для атаки черного отшельника: '.$index_to.'<br>'; }
...
if($index_to) {  $hod_one=$index; $hod_two=$index_to; }
    ...
    if($sh[$index+22]>0 && $sh[$index+22]<10) { $index_to=$index+22; echo 'Выбрана цель для атаки белого отшельника: '.$index_to.'<br>'; }
    if($sh[$index+26]>0 && $sh[$index+26]<10) { $index_to=$index+26; echo 'Выбрана цель для атаки белого отшельника: '.$index_to.'<br>'; }
    if($sh[$index-22]>0 && $sh[$index-22]<10) { $index_to=$index-22; echo 'Выбрана цель для атаки белого отшельника: '.$index_to.'<br>'; }
    if($sh[$index-26]>0 && $sh[$index-26]<10) { $index_to=$index-26; echo 'Выбрана цель для атаки белого отшельника: '.$index_to.'<br>'; }
    if($sh[$index+47]>0 && $sh[$index+47]<10) { $index_to=$index+47; echo 'Выбрана цель для атаки белого отшельника: '.$index_to.'<br>'; }
    if($sh[$index+49]>0 && $sh[$index+49]<10) { $index_to=$index+49; echo 'Выбрана цель для атаки белого отшельника: '.$index_to.'<br>'; }
    if($sh[$index-47]>0 && $sh[$index-47]<10) { $index_to=$index-47; echo 'Выбрана цель для атаки белого отшельника: '.$index_to.'<br>'; }
    if($sh[$index-49]>0 && $sh[$index-49]<10) { $index_to=$index-49; echo 'Выбрана цель для атаки белого отшельника: '.$index_to.'<br>'; }
