...
if($sh[$g]=='1' || $sh[$g]=='11') { $alt[$g]='Пешка'; }
if($sh[$g]=='2' || $sh[$g]=='12') { $alt[$g]='Ладья'; }
if($sh[$g]=='3' || $sh[$g]=='13') { $alt[$g]='Конь'; }
if($sh[$g]=='4' || $sh[$g]=='14') { $alt[$g]='Слон'; }
if($sh[$g]=='5' || $sh[$g]=='15') { $alt[$g]='Ферзь'; }
if($sh[$g]=='6' || $sh[$g]=='16') { $alt[$g]='Король'; }
if($sh[$g]=='7' || $sh[$g]=='17') { $alt[$g]='Дракон'; }
if($sh[$g]=='8' || $sh[$g]=='18') { $alt[$g]='Стрела'; }
if($sh[$g]=='9' || $sh[$g]=='19') { $alt[$g]='Отшельник'; }
if($sh[$g]=='81') { $alt[$g]='Домик'; }
if($sh[$g]=='82') { $alt[$g]='Бомба'; }
if($sh[$g]=='84') { $alt[$g]='Снежинка'; }
if($sh[$g]=='85') { $alt[$g]='Детонатор'; }
if($sh[$g]=='86') { $alt[$g]='Огонь'; }
if($sh[$g]=='90') { $alt[$g]='Подарок'; }
if($sh[$g]=='91') { $alt[$g]='Замок'; }
if($sh[$g]=='92') { $alt[$g]='База'; }
if($sh[$g]=='93') { $alt[$g]='Алмаз'; }
if($sh[$g]=='94') { $alt[$g]='Стена'; }
