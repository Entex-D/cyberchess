...
<table width=90%><tr>
<td class=td_center><center><font size=4><br><strong><a href=#>[[</a> Просмотр доски <? echo $nomer3; ?> игрока <? echo $namer; ?> <a href=#>]]</a></strong><br></font></center></td></tr></table>
...
$ndoski='../archive_doski/'.$namer.'/tip3/'.$nomer3.'/'.$nomer3.'_hody.txt';
 $b4='0';
...
$fdoski='../archive_doski/'.$namer.'/tip3/'.$nomer3.'/'.$nomer3.'.txt';
 $b5='0';
...
$fstatix='../archive_doski/'.$namer.'/tip3/'.$nomer3.'/'.$nomer3.'_statix.txt';
 $b6='0';
...
<? include('../variant3/shah.php'); ?>
<? if($zvuki_hody=='11') { include('../variant3/zvuk_uvel.php'); } ?>
...
if($figury[$sx]=='7') { $sh[$sx]='../picture/new_figure/black_dracon.png'; }
if($figury[$sx]=='9') { $sh[$sx]='../picture/new_figure/otshelnik_black.jpg'; }
...
if($figury[$sx]=='17') { $sh[$sx]='../picture/'.$figure_x.'white_dracon.png'; }
if($figury[$sx]=='18') { $sh[$sx]='../picture/'.$figure_x.'white_strela.png'; }
if($figury[$sx]=='8') { $sh[$sx]='../picture/new_figure/black_strela.png'; }
if($figury[$sx]=='19') { $sh[$sx]='../picture/'.$figure_x.'otshelnik_white.png'; }
...
<? echo '&nbsp;&nbsp;&nbsp;&nbsp;Правила на доске '.$nomer3.', игрока '.$namer.':'; ?>
</strong><br><br></font>

<? $fixxa='figure_style'.$style_run.'/'; ?>

<font size=2><strong><em>
&nbsp;&nbsp;&nbsp;&nbsp;<a target=_blank href=../model_game/<? echo $fixxa; ?>pravila_strela.jpg>Правила ходов у Стрелы</a><br>
&nbsp;&nbsp;&nbsp;&nbsp;<a target=_blank href=../model_game/<? echo $fixxa; ?>pravila_dracon_tip8.jpg>Правила ходов у Дракона</a><br>
&nbsp;&nbsp;&nbsp;&nbsp;<a target=_blank href=../model_game/<? echo $fixxa; ?>pravila_otshelnik.jpg>Правила ходов у Отшельника</a><br>

<br>

Конь,Ладья,Слон,Ферзь,Стрела и Дракон могут меняться местами<br>
Каждые <? echo $transform_index; ?> ходов 6 фигур рандомно превращаются ( Конь, Слон, Ферзь, Ладья, Стрела и Дракон )<br>
За убитые фигуры зачисляются баллы<br>
За 20 баллов случайная пешка превращается в Стрелу,Дракона или в Отшельника<br>
...
<meta http-equiv='refresh' content='40;url=archive_d_tip4_uvel.php?namer=<? echo $namer; ?>&tip=3&nomer3=<? echo $nomer3; ?>'>
