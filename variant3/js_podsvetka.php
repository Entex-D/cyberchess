...
if (sh_d[f]=='18' | sh_d[f]=='8') {
    ...
    const x1Cell = document.getElementById(di[f+2]);
            ...
            const x6Cell = document.getElementById(di[f+46]);
            const x3Cell = document.getElementById(di[f-46]);
            const x7Cell = document.getElementById(di[f+50]);
            const x8Cell = document.getElementById(di[f-50]);

            const x11Cell = document.getElementById(di[f+3]);
            const x12Cell = document.getElementById(di[f-3]);
            const x13Cell = document.getElementById(di[f+72]);
            const x14Cell = document.getElementById(di[f-72]);
            ...
            const x21Cell = document.getElementById(di[f+26]);
            const x22Cell = document.getElementById(di[f-26]);
...
if (sh_d[f]=='17' | sh_d[f]=='7') {
    ...
    const x1Cell = document.getElementById(di[f+23]);
            ...
            const x7Cell = document.getElementById(di[f+22]);
            const x8Cell = document.getElementById(di[f-22]);
            const x11Cell = document.getElementById(di[f+47]);
            const x12Cell = document.getElementById(di[f-47]);
            const x13Cell = document.getElementById(di[f+49]);
            const x14Cell = document.getElementById(di[f-49]);

            const x15Cell = document.getElementById(di[f+1]);
            const x16Cell = document.getElementById(di[f-1]);
            const x17Cell = document.getElementById(di[f+2]);
            const x18Cell = document.getElementById(di[f-2]);
            const x19Cell = document.getElementById(di[f+24]);
            const x20Cell = document.getElementById(di[f-24]);
            const x21Cell = document.getElementById(di[f+48]);
            const x22Cell = document.getElementById(di[f-48]);
...
if (sh_d[f]=='19' | sh_d[f]=='9') {
            const x1Cell = document.getElementById(di[f+46]);
            const x2Cell = document.getElementById(di[f-46]);
            const x3Cell = document.getElementById(di[f+50]);
            const x4Cell = document.getElementById(di[f-50]);
