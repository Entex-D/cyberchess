...
$sxx1='./archive_doski/'.$doska.'/tip8/'.$nomer_doski8.'/'.$nomer_doski8.'_hod_vartical_off.txt';
...
$data_x='./archive_doski/'.$doska.'/tip8/'.$nomer_doski8.'/'.$nomer_doski8.'_hod_vartical_off.txt';
...
$data1='./archive_doski/'.$doska.'/tip8/'.$nomer_doski8.'/'.$nomer_doski8.'_hod_vartical_off.txt';
