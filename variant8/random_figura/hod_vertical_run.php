...
if($shah!='1' && $shah!='2' && $shah_off[0]!='1' && $shah_off[1]=='2') {
if($exxo[21]>'9' || $exxo[22]>'9') {

if($exxo[11]=='Белые' && $hod_one<'1000') {

 if($sh[$hod_one]!=$load_white[0] && $sh[$hod_one]!=$load_white[1] && $sh[$hod_one]!=$load_white[2]) { $hod_one='1000'; $hod_two='1000'; 
 echo '<br>Ход отменен,ход не разрешенной фигурой'; }

                          }

if($exxo[11]=='Черные' && $hod_one<'1000') {

 if($sh[$hod_one]!=$load_black[0] && $sh[$hod_one]!=$load_black[1] && $sh[$hod_one]!=$load_black[2]) { $hod_one='1000'; $hod_two='1000'; 
 echo '<br>Ход отменен,ход не разрешенной фигурой'; }
