...
<table width=90%><tr>
<td class=td_center><center><font size=4><br><strong><a href=#>[[</a> Просмотр доски <? echo $nomer8; ?> игрока <? echo $namer; ?> <a href=#>]]</a></strong><br></font></center></td></tr></table>
...
$ndoski='../archive_doski/'.$namer.'/tip8/'.$nomer8.'/'.$nomer8.'_hody.txt';
 $b4='0';
...
$fdoski='../archive_doski/'.$namer.'/tip8/'.$nomer8.'/'.$nomer8.'.txt';
 $b5='0';
...
$fstatix='../archive_doski/'.$namer.'/tip8/'.$nomer8.'/'.$nomer8.'_statix.txt';
 $b6='0';
...
<? include('../variant8/shah.php'); ?>
<? if($zvuki_hody=='11') { include('../variant8/zvuk_uvel.php'); } ?>
...
<br> <div class="cell2" id="">7</div>
  ...
  <? $x=$x+'15'; ?> <div class="cell dark" id="A7" style="background-color:<? echo $color_b[$x]; ?>"><img src="<?echo $sh[$x]?>" title="<? echo $alt[$x]; ?>" <? echo 'width='.$width; echo 'height='.$height; ?>></div>
 ...
 <div class="cell2" id="">6</div>
  ...
  <? $x=$x+'15'; ?> <div class="cell" id="A6" style="background-color:<? echo $color_b[$x]; ?>"><img src="<?echo $sh[$x]?>" title="<? echo $alt[$x]; ?>" <? echo 'width='.$width; echo 'height='.$height; ?>></div>
 ...
 <div class="cell2" id="">5</div>
  ...
  <? $x=$x+'15'; ?> <div class="cell dark" id="A5" style="background-color:<? echo $color_b[$x]; ?>"><img src="<?echo $sh[$x]?>" title="<? echo $alt[$x]; ?>" <? echo 'width='.$width; echo 'height='.$height; ?>></div>
 ...
 <div class="cell2" id="">4</div>
  ...
  <? $x=$x+'15'; ?> <div class="cell" id="A4" style="background-color:<? echo $color_b[$x]; ?>"><img src="<?echo $sh[$x]?>" title="<? echo $alt[$x]; ?>" <? echo 'width='.$width; echo 'height='.$height; ?>></div>
...
<div class="cell2" id="">3</div>
  ...
  <? $x=$x+'15'; ?> <div class="cell dark" id="A3" style="background-color:<? echo $color_b[$x]; ?>"><img src="<?echo $sh[$x]?>" title="<? echo $alt[$x]; ?>" <? echo 'width='.$width; echo 'height='.$height; ?>></div>
 ...
 <div class="cell2" id="">2</div>
  ...
  <? $x=$x+'15'; ?> <div class="cell" id="A2" style="background-color:<? echo $color_b[$x]; ?>"><img src="<?echo $sh[$x]?>" title="<? echo $alt[$x]; ?>" <? echo 'width='.$width; echo 'height='.$height; ?>></div>
...
<div class="cell2" id="">1</div>
  ...
  <? $x=$x+'15'; ?> <div class="cell dark" id="A1" style="background-color:<? echo $color_b[$x]; ?>"><img src="<?echo $sh[$x]?>" title="<? echo $alt[$x]; ?>" <? echo 'width='.$width; echo 'height='.$height; ?>></div>
...
<? echo '&nbsp;&nbsp;&nbsp;&nbsp;Правила на доске '.$nomer8.', игрока '.$namer.':'; ?>
</strong><br><br></font>
...
<meta http-equiv='refresh' content='40;url=archive_d_tip4_uvel.php?namer=<? echo $namer; ?>&tip=8&nomer8=<? echo $nomer8; ?>'>
