...
<div id="table">
   ...
   <div class="cell" id="K1" style="background-color:<? echo $color_b[$x]; ?>"><img src="<?echo $arImages[$sh[$x]]?>" title="<? echo $alt[$x]; ?>" <? echo 'width='.$width; echo 'height='.$height; ?>></div>
   ...
   <? $x=$x-'15'; ?><div class="cell dark" id="K2" style="background-color:<? echo $color_b[$x]; ?>"><img src="<?echo $arImages[$sh[$x]]?>" title="<? echo $alt[$x]; ?>" <? echo 'width='.$width; echo 'height='.$height; ?>></div>
   ...
   <? $x=$x-'15'; ?><div class="cell" id="K3" style="background-color:<? echo $color_b[$x]; ?>"><img src="<?echo $arImages[$sh[$x]]?>" title="<? echo $alt[$x]; ?>" <? echo 'width='.$width; echo 'height='.$height; ?>></div>
   ...
   <? $x=$x-'15'; ?><div class="cell dark" id="K4" style="background-color:<? echo $color_b[$x]; ?>"><img src="<?echo $arImages[$sh[$x]]?>" title="<? echo $alt[$x]; ?>" <? echo 'width='.$width; echo 'height='.$height; ?>></div>
   ...
   <? $x=$x-'15'; ?><div class="cell" id="K5" style="background-color:<? echo $color_b[$x]; ?>"><img src="<?echo $arImages[$sh[$x]]?>" title="<? echo $alt[$x]; ?>" <? echo 'width='.$width; echo 'height='.$height; ?>></div>
   ...
   <? $x=$x-'15'; ?><div class="cell dark" id="K6" style="background-color:<? echo $color_b[$x]; ?>"><img src="<?echo $arImages[$sh[$x]]?>" title="<? echo $alt[$x]; ?>" <? echo 'width='.$width; echo 'height='.$height; ?>></div>
   ...
   <? $x=$x-'15'; ?><div class="cell" id="K7" style="background-color:<? echo $color_b[$x]; ?>"><img src="<?echo $arImages[$sh[$x]]?>" title="<? echo $alt[$x]; ?>" <? echo 'width='.$width; echo 'height='.$height; ?>></div>
   ...
   <? $x=$x-'15'; ?><div class="cell dark" id="K8" style="background-color:<? echo $color_b[$x]; ?>"><img src="<?echo $arImages[$sh[$x]]?>" title="<? echo $alt[$x]; ?>" <? echo 'width='.$width; echo 'height='.$height; ?>></div>
