...
if($sopernik) { if($nomer8 || $nomer_doski8) { unset($nomer8);  unset($nomer_doski8);
                              setcookie ("nomer8", $nomer8, time() );  setcookie ("nomer_doski8", $nomer_doski8, time() );         }
                   }
...
if(!file_exists($sxx))   {  //echo 'файл '.$sxx.' присутствует';
                          ...
                          setcookie ("nomer_doski8", $nomer_doski8, time() + 1);
                          setcookie ("nomer8", $nomer8, time() + 1);
                     ?>
...
if($_POST['sbros']) { 
//$game='5'; 
//$nomer8_rezet=''; $nomer8=$nomer8_rezet;
setcookie ("game", $game, time() + 4);
 setcookie ("nomer_doski8", $nomer_doski8, time() + 1);  
 setcookie ("nomer8", $nomer8, time() + 1);  
...
setcookie ("game", $game, time() + 4);
 setcookie ("nomer_doski8", $nomer_doski8, time() + 1);  
// setcookie ("nomer8", $nomer8,4 time() + 1);  
 setcookie ("timer", $timer, time() + 1);  
setcookie ("btc", $btc, time() + 1);  
$rrt='4'; 
...
if($nomer8>' ') {  setcookie ("nomer8", $nomer8, time() +3600);  }

//если нет своей игры,и открываю свою игру из оповещений
if(!$nomer_doski8 && $nomer8) { $nomer_doski8=$nomer8; setcookie ("nomer_doski8", $nomer_doski8, time() +3600*24*700); }

//echo '<br>$nomer8='.$nomer8;
