...
<tr>
<td class=td_centerl bgcolor=#606060><font size=6 color=#cdcdcd><strong<em><center>
<?
...
if($name==$exxo[3]) {
 echo '&nbsp;&nbsp;<font size=5><em>Белые:</em></font> '.$exxina13.' </td></tr><tr><td class=td_centerl bgcolor=#464646><font size=6 color=#cdcdcd><strong<em><center>
';
echo '&nbsp;&nbsp;<font size=5><em>Черные:</em></font> '.$exxina14.' ';
} else if($name==$exxo[4]) {
echo '&nbsp;&nbsp;<font size=5><em>Черные:</em></font> '.$exxina14.' </td></tr><tr><td class=td_centerl bgcolor=#464646><font size=6 color=#cdcdcd><strong<em><center>';
 echo '&nbsp;&nbsp;<font size=5><em>Белые:</em></font> '.$exxina13.' ';
