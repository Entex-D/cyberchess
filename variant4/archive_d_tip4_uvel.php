...
<table width=90%><tr>
<td class=td_center><center><font size=4><br><strong><a href=#>[[</a> Просмотр доски <? echo $nomer4; ?> игрока <? echo $namer; ?> <a href=#>]]</a></strong><br></font></center></td></tr></table>
...
$ndoski='../archive_doski/'.$namer.'/tip4/'.$nomer4.'/'.$nomer4.'_hody.txt';
 $b4='0';
...
$fdoski='../archive_doski/'.$namer.'/tip4/'.$nomer4.'/'.$nomer4.'.txt';
 $b5='0';
...
$fstatix='../archive_doski/'.$namer.'/tip4/'.$nomer4.'/'.$nomer4.'_statix.txt';
 $b6='0';
...
<? if($zvuki_hody=='11') { include('../variant4/zvuk_uvel.php'); } ?>
...
if($figury[$sx]=='1') { $sh[$sx]='../picture/krepost_black.jpg'; }
if($figury[$sx]=='2') { $sh[$sx]='../picture/heart_black.jpg'; }
if($figury[$sx]=='3') { $sh[$sx]='../picture/figure_design1/kon_black.png'; }
if($figury[$sx]=='4') { $sh[$sx]='../picture/figure_design1/slon_black.png'; }
if($figury[$sx]=='5') { $sh[$sx]='../picture/zvezda_black.jpg'; }
if($figury[$sx]=='6') { $sh[$sx]='../picture/korol_black.png'; }
if($figury[$sx]=='7') { $sh[$sx]='../picture/figure_design1/yastreb_black1.png'; }
if($figury[$sx]=='9') { $sh[$sx]='../picture/surpris_black.jpg'; }
if($figury[$sx]=='11') { $sh[$sx]='../picture/krepost_white.jpg'; }
if($figury[$sx]=='12') { $sh[$sx]='../picture/heart_white.jpg'; }
if($figury[$sx]=='13') { $sh[$sx]='../picture/figure_design1/kon.png'; }
if($figury[$sx]=='14') { $sh[$sx]='../picture/figure_design1/slon.png'; }
if($figury[$sx]=='15') { $sh[$sx]='../picture/zvezda_white.jpg'; }
if($figury[$sx]=='16') { $sh[$sx]='../picture/korol.png'; }
if($figury[$sx]=='17') { $sh[$sx]='../picture/figure_design1/yastreb_white1.png'; }
if($figury[$sx]=='18') { $sh[$sx]='../picture/figure_design1/medved_white1.png'; }
if($figury[$sx]=='8') { $sh[$sx]='../picture/figure_design1/medved_black1.png'; }
if($figury[$sx]=='19') { $sh[$sx]='../picture/surpris.jpg'; }
...
?>
 ...
 <div class="cell2" id="">8</div>
  ...
  <div class="cell id" id="A8" style="background-color:<? echo $color_b[$x]; ?>"><img src="<?echo $sh[$x]?>" title="<? echo $alt[$x]; ?>" <? echo 'width='.$width; echo 'height='.$height; ?>></div>
            ...
            <? $x=$x+'1'; ?> <div class="cell" id="I8" style="background-color:<? echo $color_b[$x]; ?>"><img src="<?echo $sh[$x]?>" title="<? echo $alt[$x]; ?>" <? echo 'width='.$width; echo 'height='.$height; ?>></div>
            <? $x=$x+'1'; ?> <div class="cell dark" id="K8" style="background-color:<? echo $color_b[$x]; ?>"><img src="<?echo $sh[$x]?>" title="<? echo $alt[$x]; ?>" <? echo 'width='.$width; echo 'height='.$height; ?>></div>
            <? $x=$x+'1'; ?> <div class="cell id" id="L8" style="background-color:<? echo $color_b[$x]; ?>"><img src="<?echo $sh[$x]?>" title="<? echo $alt[$x]; ?>" <? echo 'width='.$width; echo 'height='.$height; ?>></div>
            <? $x=$x+'1'; ?> <div class="cell dark" id="M8" style="background-color:<? echo $color_b[$x]; ?>"><img src="<?echo $sh[$x]?>" title="<? echo $alt[$x]; ?>" <? echo 'width='.$width; echo 'height='.$height; ?>></div>
        
<br> <div class="cell2" id="">7</div>

  <? $x=$x+'13'; ?> <div class="cell dark" id="A7" style="background-color:<? echo $color_b[$x]; ?>"><img src="<?echo $sh[$x]?>" title="<? echo $alt[$x]; ?>" <? echo 'width='.$width; echo 'height='.$height; ?>></div>
            ...
            <? $x=$x+'1'; ?> <div class="cell dark" id="I7" style="background-color:<? echo $color_b[$x]; ?>"><img src="<?echo $sh[$x]?>" title="<? echo $alt[$x]; ?>" <? echo 'width='.$width; echo 'height='.$height; ?>></div>
            <? $x=$x+'1'; ?> <div class="cell" id="K7" style="background-color:<? echo $color_b[$x]; ?>"><img src="<?echo $sh[$x]?>" title="<? echo $alt[$x]; ?>" <? echo 'width='.$width; echo 'height='.$height; ?>></div>
            <? $x=$x+'1'; ?> <div class="cell dark" id="L7" style="background-color:<? echo $color_b[$x]; ?>"><img src="<?echo $sh[$x]?>" title="<? echo $alt[$x]; ?>" <? echo 'width='.$width; echo 'height='.$height; ?>></div>
            <? $x=$x+'1'; ?> <div class="cell" id="M7" style="background-color:<? echo $color_b[$x]; ?>"><img src="<?echo $sh[$x]?>" title="<? echo $alt[$x]; ?>" <? echo 'width='.$width; echo 'height='.$height; ?>></div>
        
 <div class="cell2" id="">6</div>

  <? $x=$x+'13'; ?> <div class="cell" id="A6" style="background-color:<? echo $color_b[$x]; ?>"><img src="<?echo $sh[$x]?>" title="<? echo $alt[$x]; ?>" <? echo 'width='.$width; echo 'height='.$height; ?>></div>
            ...
            <? $x=$x+'1'; ?> <div class="cell" id="I6" style="background-color:<? echo $color_b[$x]; ?>"><img src="<?echo $sh[$x]?>" title="<? echo $alt[$x]; ?>" <? echo 'width='.$width; echo 'height='.$height; ?>></div>
            <? $x=$x+'1'; ?> <div class="cell dark" id="K6" style="background-color:<? echo $color_b[$x]; ?>"><img src="<?echo $sh[$x]?>" title="<? echo $alt[$x]; ?>" <? echo 'width='.$width; echo 'height='.$height; ?>></div>
            <? $x=$x+'1'; ?> <div class="cell" id="L6" style="background-color:<? echo $color_b[$x]; ?>"><img src="<?echo $sh[$x]?>" title="<? echo $alt[$x]; ?>" <? echo 'width='.$width; echo 'height='.$height; ?>></div>
            <? $x=$x+'1'; ?> <div class="cell dark" id="M6" style="background-color:<? echo $color_b[$x]; ?>"><img src="<?echo $sh[$x]?>" title="<? echo $alt[$x]; ?>" <? echo 'width='.$width; echo 'height='.$height; ?>></div>
        
 <div class="cell2" id="">5</div>

  <? $x=$x+'13'; ?> <div class="cell dark" id="A5" style="background-color:<? echo $color_b[$x]; ?>"><img src="<?echo $sh[$x]?>" title="<? echo $alt[$x]; ?>" <? echo 'width='.$width; echo 'height='.$height; ?>></div>
            ...
            <? $x=$x+'1'; ?> <div class="cell dark" id="I5" style="background-color:<? echo $color_b[$x]; ?>"><img src="<?echo $sh[$x]?>" title="<? echo $alt[$x]; ?>" <? echo 'width='.$width; echo 'height='.$height; ?>></div>
            <? $x=$x+'1'; ?> <div class="cell" id="K5" style="background-color:<? echo $color_b[$x]; ?>"><img src="<?echo $sh[$x]?>" title="<? echo $alt[$x]; ?>" <? echo 'width='.$width; echo 'height='.$height; ?>></div>
            <? $x=$x+'1'; ?> <div class="cell dark" id="L5" style="background-color:<? echo $color_b[$x]; ?>"><img src="<?echo $sh[$x]?>" title="<? echo $alt[$x]; ?>" <? echo 'width='.$width; echo 'height='.$height; ?>></div>
            <? $x=$x+'1'; ?> <div class="cell" id="M5" style="background-color:<? echo $color_b[$x]; ?>"><img src="<?echo $sh[$x]?>" title="<? echo $alt[$x]; ?>" <? echo 'width='.$width; echo 'height='.$height; ?>></div>
        
 <div class="cell2" id="">4</div>

  <? $x=$x+'13'; ?> <div class="cell" id="A4" style="background-color:<? echo $color_b[$x]; ?>"><img src="<?echo $sh[$x]?>" title="<? echo $alt[$x]; ?>" <? echo 'width='.$width; echo 'height='.$height; ?>></div>
            ...
            <? $x=$x+'1'; ?> <div class="cell" id="I4" style="background-color:<? echo $color_b[$x]; ?>"><img src="<?echo $sh[$x]?>" title="<? echo $alt[$x]; ?>" <? echo 'width='.$width; echo 'height='.$height; ?>></div>
            <? $x=$x+'1'; ?> <div class="cell dark" id="K4" style="background-color:<? echo $color_b[$x]; ?>"><img src="<?echo $sh[$x]?>" title="<? echo $alt[$x]; ?>" <? echo 'width='.$width; echo 'height='.$height; ?>></div>
            <? $x=$x+'1'; ?> <div class="cell" id="L4" style="background-color:<? echo $color_b[$x]; ?>"><img src="<?echo $sh[$x]?>" title="<? echo $alt[$x]; ?>" <? echo 'width='.$width; echo 'height='.$height; ?>></div>
            <? $x=$x+'1'; ?> <div class="cell dark" id="M4" style="background-color:<? echo $color_b[$x]; ?>"><img src="<?echo $sh[$x]?>" title="<? echo $alt[$x]; ?>" <? echo 'width='.$width; echo 'height='.$height; ?>></div>
        
<div class="cell2" id="">3</div>

  <? $x=$x+'13'; ?> <div class="cell dark" id="A3" style="background-color:<? echo $color_b[$x]; ?>"><img src="<?echo $sh[$x]?>" title="<? echo $alt[$x]; ?>" <? echo 'width='.$width; echo 'height='.$height; ?>></div>
            ...
            <? $x=$x+'1'; ?> <div class="cell dark" id="I3" style="background-color:<? echo $color_b[$x]; ?>"><img src="<?echo $sh[$x]?>" title="<? echo $alt[$x]; ?>" <? echo 'width='.$width; echo 'height='.$height; ?>></div>
            <? $x=$x+'1'; ?> <div class="cell" id="K3" style="background-color:<? echo $color_b[$x]; ?>"><img src="<?echo $sh[$x]?>" title="<? echo $alt[$x]; ?>" <? echo 'width='.$width; echo 'height='.$height; ?>></div>
            <? $x=$x+'1'; ?> <div class="cell dark" id="L3" style="background-color:<? echo $color_b[$x]; ?>"><img src="<?echo $sh[$x]?>" title="<? echo $alt[$x]; ?>" <? echo 'width='.$width; echo 'height='.$height; ?>></div>
            <? $x=$x+'1'; ?> <div class="cell" id="M3" style="background-color:<? echo $color_b[$x]; ?>"><img src="<?echo $sh[$x]?>" title="<? echo $alt[$x]; ?>" <? echo 'width='.$width; echo 'height='.$height; ?>></div>
        
 <div class="cell2" id="">2</div>

  <? $x=$x+'13'; ?> <div class="cell" id="A2" style="background-color:<? echo $color_b[$x]; ?>"><img src="<?echo $sh[$x]?>" title="<? echo $alt[$x]; ?>" <? echo 'width='.$width; echo 'height='.$height; ?>></div>
            ...
            <? $x=$x+'1'; ?> <div class="cell" id="I2" style="background-color:<? echo $color_b[$x]; ?>"><img src="<?echo $sh[$x]?>" title="<? echo $alt[$x]; ?>" <? echo 'width='.$width; echo 'height='.$height; ?>></div>
            <? $x=$x+'1'; ?> <div class="cell dark" id="K2" style="background-color:<? echo $color_b[$x]; ?>"><img src="<?echo $sh[$x]?>" title="<? echo $alt[$x]; ?>" <? echo 'width='.$width; echo 'height='.$height; ?>></div>
            <? $x=$x+'1'; ?> <div class="cell" id="L2" style="background-color:<? echo $color_b[$x]; ?>"><img src="<?echo $sh[$x]?>" title="<? echo $alt[$x]; ?>" <? echo 'width='.$width; echo 'height='.$height; ?>></div>
            <? $x=$x+'1'; ?> <div class="cell dark" id="M2" style="background-color:<? echo $color_b[$x]; ?>"><img src="<?echo $sh[$x]?>" title="<? echo $alt[$x]; ?>" <? echo 'width='.$width; echo 'height='.$height; ?>></div>
        
<div class="cell2" id="">1</div>

  <? $x=$x+'13'; ?> <div class="cell dark" id="A1" style="background-color:<? echo $color_b[$x]; ?>"><img src="<?echo $sh[$x]?>" title="<? echo $alt[$x]; ?>" <? echo 'width='.$width; echo 'height='.$height; ?>></div>
            ...
            <? $x=$x+'1'; ?> <div class="cell dark" id="I1" style="background-color:<? echo $color_b[$x]; ?>"><img src="<?echo $sh[$x]?>" title="<? echo $alt[$x]; ?>" <? echo 'width='.$width; echo 'height='.$height; ?>></div>
            <? $x=$x+'1'; ?> <div class="cell" id="K1" style="background-color:<? echo $color_b[$x]; ?>"><img src="<?echo $sh[$x]?>" title="<? echo $alt[$x]; ?>" <? echo 'width='.$width; echo 'height='.$height; ?>></div>
            <? $x=$x+'1'; ?> <div class="cell dark" id="L1" style="background-color:<? echo $color_b[$x]; ?>"><img src="<?echo $sh[$x]?>" title="<? echo $alt[$x]; ?>" <? echo 'width='.$width; echo 'height='.$height; ?>></div>
            <? $x=$x+'1'; ?> <div class="cell id" id="M1" style="background-color:<? echo $color_b[$x]; ?>"><img src="<?echo $sh[$x]?>" title="<? echo $alt[$x]; ?>" <? echo 'width='.$width; echo 'height='.$height; ?>></div>
...
<? echo '&nbsp;&nbsp;&nbsp;&nbsp;Правила на доске '.$nomer4.', игрока '.$namer.':'; ?>
</strong><br><br></font>

<? $fixxa='figure_style'.$style_run.'/'; ?>

<font size=2><strong><em>
&nbsp;&nbsp;&nbsp;&nbsp;<a target=_blank href=../model_game/<? echo $fixxa; ?>pravila_yastreb_tip6.jpg>Правила ходов у Ястреба</a><br>
&nbsp;&nbsp;&nbsp;&nbsp;<a target=_blank href=../model_game/<? echo $fixxa; ?>pravila_medved_tip6.jpg>Правила ходов у Медведя</a><br>

<br>

Шестью конями взрывать крепости<br>
За убитые крепости зачисляются 1 балл<br>
Ход на клетку Сюрприз дает 5 баллов,и вокруг появляются 8 Сердечек<br>
Ход на сердечко дает 8 баллов<br>
Клетка Звезда меняет позицию при каждом ходе<br>
При ходе на клетку Звезда зачисляется 10 баллов и появляются 2 крепости<br>
За 20 баллов случайная крепость превращается в Медведя,Ястреба или в Сюрприз<br>
</em></strong><br></font>
...
<meta http-equiv='refresh' content='40;url=archive_d_tip4_uvel.php?namer=<? echo $namer; ?>&tip=4&nomer4=<? echo $nomer4; ?>'>
