...
if($sopernik) { if($nomer4 || $nomer_doski4) { unset($nomer4);  unset($nomer_doski4);
                              setcookie ("nomer4", $nomer4, time() );  setcookie ("nomer_doski4", $nomer_doski4, time() );         }
                   }
...
if(!file_exists($sxx))   {  //echo 'файл '.$sxx.' присутствует';
                          ...
                          setcookie ("nomer_doski4", $nomer_doski4, time() + 1);
                          setcookie ("nomer4", $nomer4, time() + 1);
                     ?>
...
if($_POST['sbros']) { 
//$game='5'; 
//$nomer4_rezet=''; $nomer4=$nomer4_rezet;
setcookie ("game", $game, time() + 1);
setcookie ("nomer_doski4", $nomer_doski4, time() );  
 setcookie ("nomer4", $nomer4, time() );  
...
setcookie ("game", $game, time() + 4);
 setcookie ("nomer_doski4", $nomer_doski4, time() + 1);  
// setcookie ("nomer4", $nomer4,4 time() + 1);  
 setcookie ("timer", $timer, time() + 1);  
setcookie ("btc", $btc, time() + 1);  
$rrt='4'; 
...
if($nomer4>' ') {  setcookie ("nomer4", $nomer4, time() +3600);  }

//если нет своей игры,и открываю свою игру из оповещений
if(!$nomer_doski4 && $nomer4) { $nomer_doski4=$nomer4; setcookie ("nomer_doski4", $nomer_doski4, time() +3600*24*700); }

//echo '<br>$nomer4='.$nomer4;
