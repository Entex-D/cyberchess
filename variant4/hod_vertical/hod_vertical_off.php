...
$sxx1='./archive_doski/'.$doska.'/tip4/'.$nomer_doski4.'/'.$nomer_doski4.'_hod_vartical_off.txt';
...
$data_x='./archive_doski/'.$doska.'/tip4/'.$nomer_doski4.'/'.$nomer_doski4.'_hod_vartical_off.txt';
...
$data1='./archive_doski/'.$doska.'/tip4/'.$nomer_doski4.'/'.$nomer_doski4.'_hod_vartical_off.txt';
