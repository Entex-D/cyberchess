...
$zet1='../sea_battle/igrok/'.$dir_file_cnt[$s].'_figure.txt';
$zet2='../sea_battle/igrok/hod/'.$dir_file_cnt[$s].'_hod.txt';
$zet3='../sea_battle/igrok/analiz/'.$dir_file_cnt[$s].'_analiz.txt';
$zet4='../sea_battle/igrok/analiz/'.$dir_file_cnt[$s].'_analiz_comp.txt';
$zet5='../sea_battle/igrok/'.$dir_file_cnt[$s].'_figure_comp.txt';
...
if($mex[0]=='0' || $mex[0]<' ') {  $s4=$s4+1; //echo '<br>'.$s.'.'.$zet1; echo '<br>'.$s.'.'.$zet2; echo '<br>'.$s.'.'.$zet3;  echo '<br>'.$s.'.'.$zet4; echo '<br>'.$s.'.'.$zet5; 
