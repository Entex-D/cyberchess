...
$write_hod='../sea_battle/igrok/hod/'.$nick.'_hod.txt';
...
$logi_text='<font size=1><em>'.date("d.m.Y|G:i:s ").'</em></font> Игрок <strong><em>'.$nick.'</em></strong> играет в Морской бой #1: <strong>'.$hod.$dexo.'</strong>';
