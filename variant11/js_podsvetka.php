...
if (sh_d[f]=='19' | sh_d[f]=='9') {
            ...
            const x4Cell = document.getElementById(di[f-24]);
            const x5Cell = document.getElementById(di[f+23]);
            const x6Cell = document.getElementById(di[f-23]);
            const x7Cell = document.getElementById(di[f+25]);
            ...
            const x11Cell = document.getElementById(di[f+3]);
            const x12Cell = document.getElementById(di[f-3]);
            const x13Cell = document.getElementById(di[f+48]);
            const x14Cell = document.getElementById(di[f-48]);
            const x15Cell = document.getElementById(di[f+72]);
            const x16Cell = document.getElementById(di[f-72]);
            
            const x17Cell = document.getElementById(di[f+26]);
            const x18Cell = document.getElementById(di[f-26]);
            const x19Cell = document.getElementById(di[f+27]);
            const x20Cell = document.getElementById(di[f-27]);
            const x21Cell = document.getElementById(di[f+22]);
            const x22Cell = document.getElementById(di[f-22]);
            const x23Cell = document.getElementById(di[f+21]);
            const x24Cell = document.getElementById(di[f-21]);
         
            const x25Cell = document.getElementById(di[f+49]);
            const x26Cell = document.getElementById(di[f-49]);
            const x27Cell = document.getElementById(di[f+47]);
            const x28Cell = document.getElementById(di[f-47]);
            const x29Cell = document.getElementById(di[f+73]);
            const x30Cell = document.getElementById(di[f-73]);
            const x31Cell = document.getElementById(di[f+71]);
            const x32Cell = document.getElementById(di[f-71]);
            const x33Cell = document.getElementById(di[f+50]);
            const x34Cell = document.getElementById(di[f-50]);
            const x35Cell = document.getElementById(di[f+46]);
            const x36Cell = document.getElementById(di[f-46]);
         
                   if(x1Cell !== null) {    x1Cell.classList.toggle('highlighted2');   }
              if(x2Cell !== null) {    x2Cell.classList.toggle('highlighted2');   }
              if(x3Cell !== null) {    x3Cell.classList.toggle('highlighted2');   }
              if(x4Cell !== null) {    x4Cell.classList.toggle('highlighted2');   }
              if(x5Cell !== null) {    x5Cell.classList.toggle('highlighted2');   }
              if(x6Cell !== null) {    x6Cell.classList.toggle('highlighted2');   }
              if(x7Cell !== null) {    x7Cell.classList.toggle('highlighted2');   }
              if(x8Cell !== null) {    x8Cell.classList.toggle('highlighted2');   }
              ...
              if(x13Cell !== null) {    x13Cell.classList.toggle('highlighted');   }
              if(x14Cell !== null) {    x14Cell.classList.toggle('highlighted');   }
              if(x15Cell !== null) {    x15Cell.classList.toggle('highlighted');   }
              if(x16Cell !== null) {    x16Cell.classList.toggle('highlighted');   }

              if(x17Cell !== null) {    x17Cell.classList.toggle('highlighted');   }
              if(x18Cell !== null) {    x18Cell.classList.toggle('highlighted');   }
              if(x19Cell !== null) {    x19Cell.classList.toggle('highlighted');   }
              if(x20Cell !== null) {    x20Cell.classList.toggle('highlighted');   }
              if(x21Cell !== null) {    x21Cell.classList.toggle('highlighted');   }
              if(x22Cell !== null) {    x22Cell.classList.toggle('highlighted');   }
              if(x23Cell !== null) {    x23Cell.classList.toggle('highlighted');   }
              if(x24Cell !== null) {    x24Cell.classList.toggle('highlighted');   }
        
              if(x25Cell !== null) {    x25Cell.classList.toggle('highlighted');   }
              if(x26Cell !== null) {    x26Cell.classList.toggle('highlighted');   }
              if(x27Cell !== null) {    x27Cell.classList.toggle('highlighted');   }
              if(x28Cell !== null) {    x28Cell.classList.toggle('highlighted');   }
              if(x29Cell !== null) {    x29Cell.classList.toggle('highlighted');   }
              if(x30Cell !== null) {    x30Cell.classList.toggle('highlighted');   }
              if(x31Cell !== null) {    x31Cell.classList.toggle('highlighted');   }
              if(x32Cell !== null) {    x32Cell.classList.toggle('highlighted');   }
              if(x33Cell !== null) {    x33Cell.classList.toggle('highlighted');   }
              if(x34Cell !== null) {    x34Cell.classList.toggle('highlighted');   }
              if(x35Cell !== null) {    x35Cell.classList.toggle('highlighted');   }
              if(x36Cell !== null) {    x36Cell.classList.toggle('highlighted');   }
...
if (sh_d[f]=='14' | sh_d[f]=='4') {
     ...
     if(x5Cell !== null) {     if(sh_d[f+50]<'40')   {       x5Cell.classList.toggle('highlighted2'); } else x5Cell.classList.toggle('highlighted'); }
     if(x6Cell !== null) {     if(sh_d[f-50]<'40')   {       x6Cell.classList.toggle('highlighted2'); } else x6Cell.classList.toggle('highlighted'); }
     if(x7Cell !== null) {     if(sh_d[f+46]<'40')   {       x7Cell.classList.toggle('highlighted2'); } else x7Cell.classList.toggle('highlighted'); }       
     if(x8Cell !== null) {     if(sh_d[f-46]<'40')   {       x8Cell.classList.toggle('highlighted2'); } else x8Cell.classList.toggle('highlighted'); }
     
     if(x9Cell !== null) {     if(sh_d[f+75]<'40')   {       x9Cell.classList.toggle('highlighted2'); } else x9Cell.classList.toggle('highlighted'); }
     if(x10Cell !== null) {     if(sh_d[f-75]<'40')   {       x10Cell.classList.toggle('highlighted2'); } else x10Cell.classList.toggle('highlighted'); }
     if(x11Cell !== null) {     if(sh_d[f+69]<'40')   {       x11Cell.classList.toggle('highlighted2'); } else x11Cell.classList.toggle('highlighted'); }
     if(x12Cell !== null) {     if(sh_d[f-69]<'40')   {       x12Cell.classList.toggle('highlighted2'); } else x12Cell.classList.toggle('highlighted'); }
     
     if(x13Cell !== null) {     if(sh_d[f+100]<'40')   {       x13Cell.classList.toggle('highlighted2'); } else x13Cell.classList.toggle('highlighted'); }
     if(x14Cell !== null) {     if(sh_d[f-100]<'40')   {       x14Cell.classList.toggle('highlighted2'); } else x14Cell.classList.toggle('highlighted'); }
     if(x15Cell !== null) {     if(sh_d[f+92]<'40')   {       x15Cell.classList.toggle('highlighted2'); } else x15Cell.classList.toggle('highlighted'); }
     if(x16Cell !== null) {     if(sh_d[f-92]<'40')   {       x16Cell.classList.toggle('highlighted2'); } else x16Cell.classList.toggle('highlighted'); }
     
     if(x17Cell !== null) {     if(sh_d[f+125]<'40')   {       x17Cell.classList.toggle('highlighted2'); } else x17Cell.classList.toggle('highlighted'); }
     if(x18Cell !== null) {     if(sh_d[f-125]<'40')   {       x18Cell.classList.toggle('highlighted2'); } else x18Cell.classList.toggle('highlighted'); }
     if(x19Cell !== null) {     if(sh_d[f+115]<'40')   {       x19Cell.classList.toggle('highlighted2'); } else x19Cell.classList.toggle('highlighted'); }
     if(x20Cell !== null) {     if(sh_d[f-115]<'40')   {       x20Cell.classList.toggle('highlighted2'); } else x20Cell.classList.toggle('highlighted'); }
     
     if(x21Cell !== null) {     if(sh_d[f+150]<'40')   {       x21Cell.classList.toggle('highlighted2'); } else x21Cell.classList.toggle('highlighted'); }
     if(x22Cell !== null) {     if(sh_d[f-150]<'40')   {       x22Cell.classList.toggle('highlighted2'); } else x22Cell.classList.toggle('highlighted'); }
     if(x23Cell !== null) {     if(sh_d[f+138]<'40')   {       x23Cell.classList.toggle('highlighted2'); } else x23Cell.classList.toggle('highlighted'); }
     if(x24Cell !== null) {     if(sh_d[f-138]<'40')   {       x24Cell.classList.toggle('highlighted2'); } else x24Cell.classList.toggle('highlighted'); }
     
     if(x25Cell !== null) {     if(sh_d[f+175]<'40')   {       x25Cell.classList.toggle('highlighted2'); } else x25Cell.classList.toggle('highlighted'); }
     if(x26Cell !== null) {     if(sh_d[f-175]<'40')   {       x26Cell.classList.toggle('highlighted2'); } else x26Cell.classList.toggle('highlighted'); }
     if(x27Cell !== null) {     if(sh_d[f+161]<'40')   {       x27Cell.classList.toggle('highlighted2'); } else x27Cell.classList.toggle('highlighted'); }
     if(x28Cell !== null) {     if(sh_d[f-161]<'40')   {       x28Cell.classList.toggle('highlighted2'); } else x28Cell.classList.toggle('highlighted'); }
...
if (sh_d[f]=='12' | sh_d[f]=='2') {
     ...
     if(x201Cell !== null) {     if(sh_d[f+2]<'40')   {       x201Cell.classList.toggle('highlighted2'); } else x201Cell.classList.toggle('highlighted'); }
     if(x202Cell !== null) {     if(sh_d[f+3]<'40')   {       x202Cell.classList.toggle('highlighted2'); } else x202Cell.classList.toggle('highlighted'); }
     if(x203Cell !== null) {     if(sh_d[f+4]<'40')   {       x203Cell.classList.toggle('highlighted2'); } else x203Cell.classList.toggle('highlighted'); }
     if(x204Cell !== null) {     if(sh_d[f+5]<'40')   {       x204Cell.classList.toggle('highlighted2'); } else x204Cell.classList.toggle('highlighted'); }
     if(x205Cell !== null) {     if(sh_d[f+6]<'40')   {       x205Cell.classList.toggle('highlighted2'); } else x205Cell.classList.toggle('highlighted'); }
     if(x206Cell !== null) {     if(sh_d[f+7]<'40')   {       x206Cell.classList.toggle('highlighted2'); } else x206Cell.classList.toggle('highlighted'); }
     if(x207Cell !== null) {     if(sh_d[f+8]<'40')   {       x207Cell.classList.toggle('highlighted2'); } else x207Cell.classList.toggle('highlighted'); }
     if(x208Cell !== null) {     if(sh_d[f+9]<'40')   {       x208Cell.classList.toggle('highlighted2'); } else x208Cell.classList.toggle('highlighted'); }
     if(x209Cell !== null) {     if(sh_d[f+10]<'40')   {       x209Cell.classList.toggle('highlighted2'); } else x209Cell.classList.toggle('highlighted'); }
     if(x210Cell !== null) {     if(sh_d[f+11]<'40')   {       x210Cell.classList.toggle('highlighted2'); } else x210Cell.classList.toggle('highlighted'); }

     if(x211Cell !== null) {     if(sh_d[f-1]<'40')   {       x211Cell.classList.toggle('highlighted2'); } else x211Cell.classList.toggle('highlighted'); }
     if(x212Cell !== null) {     if(sh_d[f-2]<'40')   {       x212Cell.classList.toggle('highlighted2'); } else x212Cell.classList.toggle('highlighted'); }
     if(x213Cell !== null) {     if(sh_d[f-3]<'40')   {       x213Cell.classList.toggle('highlighted2'); } else x213Cell.classList.toggle('highlighted'); }
     if(x214Cell !== null) {     if(sh_d[f-4]<'40')   {       x214Cell.classList.toggle('highlighted2'); } else x214Cell.classList.toggle('highlighted'); }
     if(x215Cell !== null) {     if(sh_d[f-5]<'40')   {       x215Cell.classList.toggle('highlighted2'); } else x215Cell.classList.toggle('highlighted'); }
     if(x216Cell !== null) {     if(sh_d[f-6]<'40')   {       x216Cell.classList.toggle('highlighted2'); } else x216Cell.classList.toggle('highlighted'); }
     if(x217Cell !== null) {     if(sh_d[f-7]<'40')   {       x217Cell.classList.toggle('highlighted2'); } else x217Cell.classList.toggle('highlighted'); }
     if(x218Cell !== null) {     if(sh_d[f-8]<'40')   {       x218Cell.classList.toggle('highlighted2'); } else x218Cell.classList.toggle('highlighted'); }
     if(x219Cell !== null) {     if(sh_d[f-9]<'40')   {       x219Cell.classList.toggle('highlighted2'); } else x219Cell.classList.toggle('highlighted'); }
     if(x220Cell !== null) {     if(sh_d[f-10]<'40')   {       x220Cell.classList.toggle('highlighted2'); } else x220Cell.classList.toggle('highlighted'); }
     if(x221Cell !== null) {     if(sh_d[f-11]<'40')   {       x221Cell.classList.toggle('highlighted2'); } else x221Cell.classList.toggle('highlighted'); }

     if(x222Cell !== null) {     if(sh_d[f-24]<'40')   {       x222Cell.classList.toggle('highlighted2'); } else x222Cell.classList.toggle('highlighted'); }
     if(x223Cell !== null) {     if(sh_d[f-48]<'40')   {       x223Cell.classList.toggle('highlighted2'); } else x223Cell.classList.toggle('highlighted'); }
     if(x224Cell !== null) {     if(sh_d[f-72]<'40')   {       x224Cell.classList.toggle('highlighted2'); } else x224Cell.classList.toggle('highlighted'); }
     if(x225Cell !== null) {     if(sh_d[f-96]<'40')   {       x225Cell.classList.toggle('highlighted2'); } else x225Cell.classList.toggle('highlighted'); }
     if(x226Cell !== null) {     if(sh_d[f-120]<'40')   {       x226Cell.classList.toggle('highlighted2'); } else x226Cell.classList.toggle('highlighted'); }
     if(x227Cell !== null) {     if(sh_d[f-144]<'40')   {       x227Cell.classList.toggle('highlighted2'); } else x227Cell.classList.toggle('highlighted'); }
     if(x228Cell !== null) {     if(sh_d[f-168]<'40')   {       x228Cell.classList.toggle('highlighted2'); } else x228Cell.classList.toggle('highlighted'); }

     if(x229Cell !== null) {     if(sh_d[f+24]<'40')   {       x229Cell.classList.toggle('highlighted2'); } else x229Cell.classList.toggle('highlighted'); }
     if(x230Cell !== null) {     if(sh_d[f+48]<'40')   {       x230Cell.classList.toggle('highlighted2'); } else x230Cell.classList.toggle('highlighted'); }
     if(x231Cell !== null) {     if(sh_d[f+72]<'40')   {       x231Cell.classList.toggle('highlighted2'); } else x231Cell.classList.toggle('highlighted'); }
     if(x232Cell !== null) {     if(sh_d[f+96]<'40')   {       x232Cell.classList.toggle('highlighted2'); } else x232Cell.classList.toggle('highlighted'); }
     if(x233Cell !== null) {     if(sh_d[f+120]<'40')   {       x233Cell.classList.toggle('highlighted2'); } else x233Cell.classList.toggle('highlighted'); }
     if(x234Cell !== null) {     if(sh_d[f+144]<'40')   {       x234Cell.classList.toggle('highlighted2'); } else x234Cell.classList.toggle('highlighted'); }
     if(x235Cell !== null) {     if(sh_d[f+168]<'40')   {       x235Cell.classList.toggle('highlighted2'); } else x235Cell.classList.toggle('highlighted'); }
...
<style>
    .highlighted {
        background-color: #CDCDCD; /* Любой цвет, который вы хотите использовать для подсветки */
    }
 .highlighted2 {
        background-color: #404040; /* Любой цвет, который вы хотите использовать для подсветки */
    }
</style>