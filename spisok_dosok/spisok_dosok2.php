...
$chet_dosok_vsego=0;
  ...
  echo '<center><table width=60% ><tr><td class=td_center bgcolor=#202020><font size=4><strong><br><center>Список всех досок варианта №2<br><br></center><strong></font></td></tr></table><table width=60%><tr><td class=td_center bgcolor=#202020><center>';
...
$data1='../ip2/hod/'.$file.'.txt';
if(!$fer = fopen($data1, "r")) {  unlink('../ip2/'.$file.'.txt');  unlink('../ip2/hod/'.$file.'.txt');  unlink('../ip2/igrok/'.$file.'.txt'); } 
fclose ($fer);
