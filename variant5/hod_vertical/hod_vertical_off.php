...
$sxx1='./archive_doski/'.$doska.'/tip5/'.$nomer_doski5.'/'.$nomer_doski5.'_hod_vartical_off.txt';
...
$data_x='./archive_doski/'.$doska.'/tip5/'.$nomer_doski5.'/'.$nomer_doski5.'_hod_vartical_off.txt';
...
$data1='./archive_doski/'.$doska.'/tip5/'.$nomer_doski5.'/'.$nomer_doski5.'_hod_vartical_off.txt';
