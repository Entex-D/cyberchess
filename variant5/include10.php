...
if($sopernik) { if($nomer5 || $nomer_doski5) { unset($nomer5);  unset($nomer_doski5);
                              setcookie ("nomer5", $nomer5, time() );  setcookie ("nomer_doski5", $nomer_doski5, time() );         }
                   }
...
if(!file_exists($sxx))   {  //echo 'файл '.$sxx.' присутствует';
                          ...
                          setcookie ("nomer_doski5", $nomer_doski5, time() + 1);
                          setcookie ("nomer5", $nomer5, time() + 1);
                     ?>
...
if($_POST['sbros']) { 
//$game='5'; 
//$nomer5_rezet=''; $nomer5=$nomer5_rezet;
setcookie ("game", $game, time() + 4);
 setcookie ("nomer_doski5", $nomer_doski5, time() + 1);  
 setcookie ("nomer5", $nomer5, time() + 1);  
...
setcookie ("game", $game, time() + 4);
 setcookie ("nomer_doski5", $nomer_doski5, time() + 1);  
// setcookie ("nomer5", $nomer5,4 time() + 1);  
 setcookie ("timer", $timer, time() + 1);  
setcookie ("btc", $btc, time() + 1);  
$rrt='4'; 
...
if($nomer5>' ') {  setcookie ("nomer5", $nomer5, time() +3600);  }

//если нет своей игры,и открываю свою игру из оповещений
if(!$nomer_doski5 && $nomer5) { $nomer_doski5=$nomer5; setcookie ("nomer_doski5", $nomer_doski5, time() +3600*24*700); }

//echo '<br>$nomer5='.$nomer5;
