...
<table width=90%><tr>
<td class=td_center><center><font size=4><br><strong><a href=#>[[</a> Просмотр доски <? echo $nomer5; ?> игрока <? echo $namer; ?> <a href=#>]]</a></strong><br></font></center></td></tr></table>
...
$ndoski='../archive_doski/'.$namer.'/tip5/'.$nomer5.'/'.$nomer5.'_hody.txt';
 $b4='0';
...
$fdoski='../archive_doski/'.$namer.'/tip5/'.$nomer5.'/'.$nomer5.'.txt';
 $b5='0';
...
$fstatix='../archive_doski/'.$namer.'/tip5/'.$nomer5.'/'.$nomer5.'_statix.txt';
 $b6='0';
...
<? if($zvuki_hody=='11') { include('../variant5/zvuk_uvel.php'); } ?>
...
if($figury[$sx]=='7') { $sh[$sx]='../picture/yastreb_black1.png'; }
if($figury[$sx]=='9') { $sh[$sx]='../picture/prizrak_black1.png'; }
...
if($figury[$sx]=='8') { $sh[$sx]='../picture/medved_black1.png'; }
...
<? echo '&nbsp;&nbsp;&nbsp;&nbsp;Правила на доске '.$nomer5.', игрока '.$namer.':'; ?>
</strong><br><br></font>
...
&nbsp;&nbsp;&nbsp;&nbsp;<a target=_blank href=../model_game/<? echo $fixxa; ?>pravila_prizrak_tip6.jpg>Правила ходов у Призрака</a><br>

<br>

Конь,Ладья,Слон,Ферзь,Ястреб и Медведь могут меняться местами<br>
Каждые <? echo $transform_index; ?> ходов 6 фигур рандомно превращаются ( Конь, Слон, Ферзь, Ладья, Ястреб, Медведь )<br>
За убитые фигуры зачисляются баллы<br>
За 20 баллов случайная пешка превращается в Ястреба ,в Медведя или в Призрака<br>
...
<meta http-equiv='refresh' content='40;url=archive_d_tip4_uvel.php?namer=<? echo $namer; ?>&tip=5&nomer5=<? echo $nomer5; ?>'>
