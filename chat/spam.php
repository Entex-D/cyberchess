...
if($name!='Hacker' && $name!='Cyber') { // если считано имя 
...
// echo " <tr><td width=1%></td><td bgcolor=".$bg_color1."><strongl><font size=2>".$date." ".$nick." ".$message."</font></strong><br></td></td><td width=1%></td><tr>";

$schet=$schet+'1';
$schet_message[$schet]=$message;

$e=$e+'1';
if($e>='2') { $e='0'; }                                                                               
                 }

} else if($name=='Hacker' || $name=='Cyber') { // если не считано имя 
...
$schet=2;
 echo '<br>'.$schet.'.'.$schet_message[$schet];
